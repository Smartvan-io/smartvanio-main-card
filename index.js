 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const lt=2;class dt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ct(t,e){const i=t.indexOf(e);i>-1&&t.splice(i,1)}const pt=(t,e,i)=>i>e?e:i<t?t:i;function ht(t,e){return e?`${t}. For more information and steps for solving, visit https://motion.dev/troubleshooting/${e}`:t}let ut=()=>{},gt=()=>{};"undefined"!=typeof process&&"production"!==process.env?.NODE_ENV&&(ut=(t,e,i)=>{t||"undefined"==typeof console||console.warn(ht(e,i))},gt=(t,e,i)=>{if(!t)throw new Error(ht(e,i))});const mt={},vt=t=>/^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t);const ft=t=>/^0[^.\s]+$/u.test(t);function bt(t){let e;return()=>(void 0===e&&(e=t()),e)}const xt=t=>t,yt=(t,e)=>i=>e(t(i)),_t=(...t)=>t.reduce(yt),wt=(t,e,i)=>{const s=e-t;return 0===s?1:(i-t)/s};class $t{constructor(){this.subscriptions=[]}add(t){var e,i;return e=this.subscriptions,i=t,-1===e.indexOf(i)&&e.push(i),()=>ct(this.subscriptions,t)}notify(t,e,i){const s=this.subscriptions.length;if(s)if(1===s)this.subscriptions[0](t,e,i);else for(let r=0;r<s;r++){const s=this.subscriptions[r];s&&s(t,e,i)}}getSize(){return this.subscriptions.length}clear(){this.subscriptions.length=0}}const kt=t=>1e3*t,St=t=>t/1e3;function Mt(t,e){return e?t*(1e3/e):0}const Tt=(t,e,i)=>(((1-3*i+3*e)*t+(3*i-6*e))*t+3*e)*t;function Ct(t,e,i,s){if(t===e&&i===s)return xt;const r=e=>function(t,e,i,s,r){let a,n,o=0;do{n=e+(i-e)/2,a=Tt(n,s,r)-t,a>0?i=n:e=n}while(Math.abs(a)>1e-7&&++o<12);return n}(e,0,1,t,i);return t=>0===t||1===t?t:Tt(r(t),e,s)}const Et=t=>e=>e<=.5?t(2*e)/2:(2-t(2*(1-e)))/2,Pt=t=>e=>1-t(1-e),At=Ct(.33,1.53,.69,.99),zt=Pt(At),Lt=Et(zt),Ot=t=>t>=1?1:(t*=2)<1?.5*zt(t):.5*(2-Math.pow(2,-10*(t-1))),It=t=>1-Math.sin(Math.acos(t)),Dt=Pt(It),Ft=Et(It),Nt=Ct(.42,0,1,1),Bt=Ct(0,0,.58,1),Rt=Ct(.42,0,.58,1),Vt=t=>Array.isArray(t)&&"number"!=typeof t[0];function jt(t,e){return Vt(t)?t[((t,e,i)=>{const s=e-t;return((i-t)%s+s)%s+t})(0,t.length,e)]:t}const Gt=t=>Array.isArray(t)&&"number"==typeof t[0],qt={linear:xt,easeIn:Nt,easeInOut:Rt,easeOut:Bt,circIn:It,circInOut:Ft,circOut:Dt,backIn:zt,backInOut:Lt,backOut:At,anticipate:Ot},Ut=t=>{if(Gt(t)){gt(4===t.length,"Cubic bezier arrays must contain four numerical values.","cubic-bezier-length");const[e,i,s,r]=t;return Ct(e,i,s,r)}return"string"==typeof t?(gt(void 0!==qt[t],`Invalid easing type '${t}'`,"invalid-easing-type"),qt[t]):t},Wt=["setup","read","resolveKeyframes","preUpdate","update","preRender","render","postRender"];function Ht(t,e){let i=!1,s=!0;const r={delta:0,timestamp:0,isProcessing:!1},a=()=>i=!0,n=Wt.reduce((t,e)=>(t[e]=function(t){let e=new Set,i=new Set,s=!1,r=!1;const a=new WeakSet;let n={delta:0,timestamp:0,isProcessing:!1};function o(e){a.has(e)&&(l.schedule(e),t()),e(n)}const l={schedule:(t,r=!1,n=!1)=>{const o=n&&s?e:i;return r&&a.add(t),o.add(t),t},cancel:t=>{i.delete(t),a.delete(t)},process:t=>{if(n=t,s)return void(r=!0);s=!0;const a=e;e=i,i=a,e.forEach(o),e.clear(),s=!1,r&&(r=!1,l.process(t))}};return l}(a),t),{}),{setup:o,read:l,resolveKeyframes:d,preUpdate:c,update:p,preRender:h,render:u,postRender:g}=n,m=()=>{const a=mt.useManualTiming,n=a?r.timestamp:performance.now();i=!1,a||(r.delta=s?1e3/60:Math.max(Math.min(n-r.timestamp,40),1)),r.timestamp=n,r.isProcessing=!0,o.process(r),l.process(r),d.process(r),c.process(r),p.process(r),h.process(r),u.process(r),g.process(r),r.isProcessing=!1,i&&e&&(s=!1,t(m))};return{schedule:Wt.reduce((e,a)=>{const o=n[a];return e[a]=(e,a=!1,n=!1)=>(i||(i=!0,s=!0,r.isProcessing||t(m)),o.schedule(e,a,n)),e},{}),cancel:t=>{for(let e=0;e<Wt.length;e++)n[Wt[e]].cancel(t)},state:r,steps:n}}const{schedule:Yt,cancel:Xt,state:Kt}=Ht("undefined"!=typeof requestAnimationFrame?requestAnimationFrame:xt,!0);let Jt;function Zt(){Jt=void 0}const Qt={now:()=>(void 0===Jt&&Qt.set(Kt.isProcessing||mt.useManualTiming?Kt.timestamp:performance.now()),Jt),set:t=>{Jt=t,queueMicrotask(Zt)}},te=t=>e=>"string"==typeof e&&e.startsWith(t),ee=te("--"),ie=te("var(--"),se=t=>!!ie(t)&&re.test(t.split("/*")[0].trim()),re=/var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;function ae(t){return"string"==typeof t&&t.split("/*")[0].includes("var(--")}const ne={test:t=>"number"==typeof t,parse:parseFloat,transform:t=>t},oe={...ne,transform:t=>pt(0,1,t)},le={...ne,default:1},de=t=>Math.round(1e5*t)/1e5,ce=/-?(?:\d+(?:\.\d+)?|\.\d+)/gu;const pe=/^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,he=(t,e)=>i=>Boolean("string"==typeof i&&pe.test(i)&&i.startsWith(t)||e&&!function(t){return null==t}(i)&&Object.prototype.hasOwnProperty.call(i,e)),ue=(t,e,i)=>s=>{if("string"!=typeof s)return s;const[r,a,n,o]=s.match(ce);return{[t]:parseFloat(r),[e]:parseFloat(a),[i]:parseFloat(n),alpha:void 0!==o?parseFloat(o):1}},ge={...ne,transform:t=>Math.round((t=>pt(0,255,t))(t))},me={test:he("rgb","red"),parse:ue("red","green","blue"),transform:({red:t,green:e,blue:i,alpha:s=1})=>"rgba("+ge.transform(t)+", "+ge.transform(e)+", "+ge.transform(i)+", "+de(oe.transform(s))+")"};const ve={test:he("#"),parse:function(t){let e="",i="",s="",r="";return t.length>5?(e=t.substring(1,3),i=t.substring(3,5),s=t.substring(5,7),r=t.substring(7,9)):(e=t.substring(1,2),i=t.substring(2,3),s=t.substring(3,4),r=t.substring(4,5),e+=e,i+=i,s+=s,r+=r),{red:parseInt(e,16),green:parseInt(i,16),blue:parseInt(s,16),alpha:r?parseInt(r,16)/255:1}},transform:me.transform},fe=t=>({test:e=>"string"==typeof e&&e.endsWith(t)&&1===e.split(" ").length,parse:parseFloat,transform:e=>`${e}${t}`}),be=fe("deg"),xe=fe("%"),ye=fe("px"),_e=fe("vh"),we=fe("vw"),$e=(()=>({...xe,parse:t=>xe.parse(t)/100,transform:t=>xe.transform(100*t)}))(),ke={test:he("hsl","hue"),parse:ue("hue","saturation","lightness"),transform:({hue:t,saturation:e,lightness:i,alpha:s=1})=>"hsla("+Math.round(t)+", "+xe.transform(de(e))+", "+xe.transform(de(i))+", "+de(oe.transform(s))+")"},Se={test:t=>me.test(t)||ve.test(t)||ke.test(t),parse:t=>me.test(t)?me.parse(t):ke.test(t)?ke.parse(t):ve.parse(t),transform:t=>"string"==typeof t?t:t.hasOwnProperty("red")?me.transform(t):ke.transform(t),getAnimatableNone:t=>{const e=Se.parse(t);return e.alpha=0,Se.transform(e)}},Me=/(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;const Te="number",Ce="color",Ee=/var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;function Pe(t){const e=t.toString(),i=[],s={color:[],number:[],var:[]},r=[];let a=0;const n=e.replace(Ee,t=>(Se.test(t)?(s.color.push(a),r.push(Ce),i.push(Se.parse(t))):t.startsWith("var(")?(s.var.push(a),r.push("var"),i.push(t)):(s.number.push(a),r.push(Te),i.push(parseFloat(t))),++a,"${}")).split("${}");return{values:i,split:n,indexes:s,types:r}}function Ae({split:t,types:e}){const i=t.length;return s=>{let r="";for(let a=0;a<i;a++)if(r+=t[a],void 0!==s[a]){const t=e[a];r+=t===Te?de(s[a]):t===Ce?Se.transform(s[a]):s[a]}return r}}const ze=(t,e)=>"number"==typeof t?e?.trim().endsWith("/")?t:0:(t=>"number"==typeof t?0:Se.test(t)?Se.getAnimatableNone(t):t)(t);const Le={test:function(t){return isNaN(t)&&"string"==typeof t&&(t.match(ce)?.length||0)+(t.match(Me)?.length||0)>0},parse:function(t){return Pe(t).values},createTransformer:function(t){return Ae(Pe(t))},getAnimatableNone:function(t){const e=Pe(t);return Ae(e)(e.values.map((t,i)=>ze(t,e.split[i])))}};function Oe(t,e,i){return i<0&&(i+=1),i>1&&(i-=1),i<1/6?t+6*(e-t)*i:i<.5?e:i<2/3?t+(e-t)*(2/3-i)*6:t}function Ie(t,e){return i=>i>0?e:t}const De=(t,e,i)=>t+(e-t)*i,Fe=(t,e,i)=>{const s=t*t,r=i*(e*e-s)+s;return r<0?0:Math.sqrt(r)},Ne=[ve,me,ke];function Be(t){const e=(t=>Ne.find(e=>e.test(t)))(t);if(ut(Boolean(e),`'${t}' is not an animatable color. Use the equivalent color code instead.`,"color-not-animatable"),!Boolean(e))return!1;let i=e.parse(t);return e===ke&&(i=function({hue:t,saturation:e,lightness:i,alpha:s}){t/=360,i/=100;let r=0,a=0,n=0;if(e/=100){const s=i<.5?i*(1+e):i+e-i*e,o=2*i-s;r=Oe(o,s,t+1/3),a=Oe(o,s,t),n=Oe(o,s,t-1/3)}else r=a=n=i;return{red:Math.round(255*r),green:Math.round(255*a),blue:Math.round(255*n),alpha:s}}(i)),i}const Re=(t,e)=>{const i=Be(t),s=Be(e);if(!i||!s)return Ie(t,e);const r={...i};return t=>(r.red=Fe(i.red,s.red,t),r.green=Fe(i.green,s.green,t),r.blue=Fe(i.blue,s.blue,t),r.alpha=De(i.alpha,s.alpha,t),me.transform(r))},Ve=new Set(["none","hidden"]);function je(t,e){return i=>De(t,e,i)}function Ge(t){return"number"==typeof t?je:"string"==typeof t?se(t)?Ie:Se.test(t)?Re:We:Array.isArray(t)?qe:"object"==typeof t?Se.test(t)?Re:Ue:Ie}function qe(t,e){const i=[...t],s=i.length,r=t.map((t,i)=>Ge(t)(t,e[i]));return t=>{for(let e=0;e<s;e++)i[e]=r[e](t);return i}}function Ue(t,e){const i={...t,...e},s={};for(const r in i)void 0!==t[r]&&void 0!==e[r]&&(s[r]=Ge(t[r])(t[r],e[r]));return t=>{for(const e in s)i[e]=s[e](t);return i}}const We=(t,e)=>{const i=Le.createTransformer(e),s=Pe(t),r=Pe(e);return s.indexes.var.length===r.indexes.var.length&&s.indexes.color.length===r.indexes.color.length&&s.indexes.number.length>=r.indexes.number.length?Ve.has(t)&&!r.values.length||Ve.has(e)&&!s.values.length?function(t,e){return Ve.has(t)?i=>i<=0?t:e:i=>i>=1?e:t}(t,e):_t(qe(function(t,e){const i=[],s={color:0,var:0,number:0};for(let r=0;r<e.values.length;r++){const a=e.types[r],n=t.indexes[a][s[a]],o=t.values[n]??0;i[r]=o,s[a]++}return i}(s,r),r.values),i):(ut(!0,`Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`,"complex-values-different"),Ie(t,e))};function He(t,e,i){if("number"==typeof t&&"number"==typeof e&&"number"==typeof i)return De(t,e,i);return Ge(t)(t,e)}const Ye=t=>{const e=({timestamp:e})=>t(e);return{start:(t=!0)=>Yt.update(e,t),stop:()=>Xt(e),now:()=>Kt.isProcessing?Kt.timestamp:Qt.now()}},Xe=(t,e,i=10)=>{let s="";const r=Math.max(Math.round(e/i),2);for(let e=0;e<r;e++)s+=Math.round(1e4*t(e/(r-1)))/1e4+", ";return`linear(${s.substring(0,s.length-2)})`},Ke=2e4;function Je(t){let e=0;let i=t.next(e);for(;!i.done&&e<Ke;)e+=50,i=t.next(e);return e>=Ke?1/0:e}function Ze(t,e=100,i){const s=i({...t,keyframes:[0,e]}),r=Math.min(Je(s),Ke);return{type:"keyframes",ease:t=>s.next(r*t).value/e,duration:St(r)}}const Qe=100,ti=10,ei=1,ii=0,si=800,ri=.3,ai=.3,ni={granular:.01,default:2},oi={granular:.005,default:.5},li=.01,di=10,ci=.05,pi=1;function hi(t,e){return t*Math.sqrt(1-e*e)}const ui=.001;const gi=["duration","bounce"],mi=["stiffness","damping","mass"];function vi(t,e){return e.some(e=>void 0!==t[e])}function fi(t){let e={velocity:ii,stiffness:Qe,damping:ti,mass:ei,isResolvedFromDuration:!1,...t};if(!vi(t,mi)&&vi(t,gi))if(e.velocity=0,t.visualDuration){const i=t.visualDuration,s=2*Math.PI/(1.2*i),r=s*s,a=2*pt(.05,1,1-(t.bounce||0))*Math.sqrt(r);e={...e,mass:ei,stiffness:r,damping:a}}else{const i=function({duration:t=si,bounce:e=ri,velocity:i=ii,mass:s=ei}){let r,a;ut(t<=kt(di),"Spring duration must be 10 seconds or less","spring-duration-limit");let n=1-e;n=pt(ci,pi,n),t=pt(li,di,St(t)),n<1?(r=e=>{const s=e*n,r=s*t,a=s-i,o=hi(e,n),l=Math.exp(-r);return ui-a/o*l},a=e=>{const s=e*n*t,a=s*i+i,o=Math.pow(n,2)*Math.pow(e,2)*t,l=Math.exp(-s),d=hi(Math.pow(e,2),n);return(-r(e)+ui>0?-1:1)*((a-o)*l)/d}):(r=e=>Math.exp(-e*t)*((e-i)*t+1)-.001,a=e=>Math.exp(-e*t)*(t*t*(i-e)));const o=function(t,e,i){let s=i;for(let i=1;i<12;i++)s-=t(s)/e(s);return s}(r,a,5/t);if(t=kt(t),isNaN(o))return{stiffness:Qe,damping:ti,duration:t};{const e=Math.pow(o,2)*s;return{stiffness:e,damping:2*n*Math.sqrt(s*e),duration:t}}}({...t,velocity:0});e={...e,...i,mass:ei},e.isResolvedFromDuration=!0}return e}function bi(t=ai,e=ri){const i="object"!=typeof t?{visualDuration:t,keyframes:[0,1],bounce:e}:t;let{restSpeed:s,restDelta:r}=i;const a=i.keyframes[0],n=i.keyframes[i.keyframes.length-1],o={done:!1,value:a},{stiffness:l,damping:d,mass:c,duration:p,velocity:h,isResolvedFromDuration:u}=fi({...i,velocity:-St(i.velocity||0)}),g=h||0,m=d/(2*Math.sqrt(l*c)),v=n-a,f=St(Math.sqrt(l/c)),b=Math.abs(v)<5;let x,y,_,w,$,k;if(s||(s=b?ni.granular:ni.default),r||(r=b?oi.granular:oi.default),m<1)_=hi(f,m),w=(g+m*f*v)/_,x=t=>{const e=Math.exp(-m*f*t);return n-e*(w*Math.sin(_*t)+v*Math.cos(_*t))},$=m*f*w+v*_,k=m*f*v-w*_,y=t=>Math.exp(-m*f*t)*($*Math.sin(_*t)+k*Math.cos(_*t));else if(1===m){x=t=>n-Math.exp(-f*t)*(v+(g+f*v)*t);const t=g+f*v;y=e=>Math.exp(-f*e)*(f*t*e-g)}else{const t=f*Math.sqrt(m*m-1);x=e=>{const i=Math.exp(-m*f*e),s=Math.min(t*e,300);return n-i*((g+m*f*v)*Math.sinh(s)+t*v*Math.cosh(s))/t};const e=(g+m*f*v)/t,i=m*f*e-v*t,s=m*f*v-e*t;y=e=>{const r=Math.exp(-m*f*e),a=Math.min(t*e,300);return r*(i*Math.sinh(a)+s*Math.cosh(a))}}const S={calculatedDuration:u&&p||null,velocity:t=>kt(y(t)),next:t=>{if(!u&&m<1){const e=Math.exp(-m*f*t),i=Math.sin(_*t),a=Math.cos(_*t),l=n-e*(w*i+v*a),d=kt(e*($*i+k*a));return o.done=Math.abs(d)<=s&&Math.abs(n-l)<=r,o.value=o.done?n:l,o}const e=x(t);if(u)o.done=t>=p;else{const i=kt(y(t));o.done=Math.abs(i)<=s&&Math.abs(n-e)<=r}return o.value=o.done?n:e,o},toString:()=>{const t=Math.min(Je(S),Ke),e=Xe(e=>S.next(t*e).value,t,30);return t+"ms "+e},toTransition:()=>{}};return S}bi.applyToOptions=t=>{const e=Ze(t,100,bi);return t.ease=e.ease,t.duration=kt(e.duration),t.type="keyframes",t};function xi(t,e,i){const s=Math.max(e-5,0);return Mt(i-t(s),e-s)}function yi({keyframes:t,velocity:e=0,power:i=.8,timeConstant:s=325,bounceDamping:r=10,bounceStiffness:a=500,modifyTarget:n,min:o,max:l,restDelta:d=.5,restSpeed:c}){const p=t[0],h={done:!1,value:p},u=t=>void 0===o?l:void 0===l||Math.abs(o-t)<Math.abs(l-t)?o:l;let g=i*e;const m=p+g,v=void 0===n?m:n(m);v!==m&&(g=v-p);const f=t=>-g*Math.exp(-t/s),b=t=>v+f(t),x=t=>{const e=f(t),i=b(t);h.done=Math.abs(e)<=d,h.value=h.done?v:i};let y,_;const w=t=>{(t=>void 0!==o&&t<o||void 0!==l&&t>l)(h.value)&&(y=t,_=bi({keyframes:[h.value,u(h.value)],velocity:xi(b,t,h.value),damping:r,stiffness:a,restDelta:d,restSpeed:c}))};return w(0),{calculatedDuration:null,next:t=>{let e=!1;return _||void 0!==y||(e=!0,x(t),w(t)),void 0!==y&&t>=y?_.next(t-y):(!e&&x(t),h)}}}function _i(t,e,{clamp:i=!0,ease:s,mixer:r}={}){const a=t.length;if(gt(a===e.length,"Both input and output ranges must be the same length","range-length"),1===a)return()=>e[0];if(2===a&&e[0]===e[1])return()=>e[1];const n=t[0]===t[1];t[0]>t[a-1]&&(t=[...t].reverse(),e=[...e].reverse());const o=function(t,e,i){const s=[],r=i||mt.mix||He,a=t.length-1;for(let i=0;i<a;i++){let a=r(t[i],t[i+1]);if(e){const t=Array.isArray(e)?e[i]||xt:e;a=_t(t,a)}s.push(a)}return s}(e,s,r),l=o.length,d=i=>{if(n&&i<t[0])return e[0];let s=0;if(l>1)for(;s<t.length-2&&!(i<t[s+1]);s++);const r=wt(t[s],t[s+1],i);return o[s](r)};return i?e=>d(pt(t[0],t[a-1],e)):d}function wi(t,e){const i=t[t.length-1];for(let s=1;s<=e;s++){const r=wt(0,e,s);t.push(De(i,1,r))}}function $i(t){const e=[0];return wi(e,t.length-1),e}function ki({duration:t=300,keyframes:e,times:i,ease:s="easeInOut"}){const r=Vt(s)?s.map(Ut):Ut(s),a={done:!1,value:e[0]},n=function(t,e){return t.map(t=>t*e)}(i&&i.length===e.length?i:$i(e),t),o=_i(n,e,{ease:Array.isArray(r)?r:(l=e,d=r,l.map(()=>d||Rt).splice(0,l.length-1))});var l,d;return{calculatedDuration:t,next:e=>(a.value=o(e),a.done=e>=t,a)}}const Si=t=>null!==t;function Mi(t,{repeat:e,repeatType:i="loop"},s,r=1){const a=t.filter(Si),n=r<0||e&&"loop"!==i&&e%2==1?0:a.length-1;return n&&void 0!==s?s:a[n]}const Ti={decay:yi,inertia:yi,tween:ki,keyframes:ki,spring:bi};function Ci(t){"string"==typeof t.type&&(t.type=Ti[t.type])}class Ei{constructor(){this.updateFinished()}get finished(){return this._finished}updateFinished(){this._finished=new Promise(t=>{this.resolve=t})}notifyFinished(){this.resolve()}then(t,e){return this.finished.then(t,e)}}const Pi=t=>t/100;class Ai extends Ei{constructor(t){super(),this.state="idle",this.startTime=null,this.isStopped=!1,this.currentTime=0,this.holdTime=null,this.playbackSpeed=1,this.delayState={done:!1,value:void 0},this.stop=()=>{const{motionValue:t}=this.options;t&&t.updatedAt!==Qt.now()&&this.tick(Qt.now()),this.isStopped=!0,"idle"!==this.state&&(this.teardown(),this.options.onStop?.())},this.options=t,this.initAnimation(),this.play(),!1===t.autoplay&&this.pause()}initAnimation(){const{options:t}=this;Ci(t);const{type:e=ki,repeat:i=0,repeatDelay:s=0,repeatType:r,velocity:a=0}=t;let{keyframes:n}=t;const o=e||ki;o!==ki&&"number"!=typeof n[0]&&(this.mixKeyframes=_t(Pi,He(n[0],n[1])),n=[0,100]);const l=o({...t,keyframes:n});"mirror"===r&&(this.mirroredGenerator=o({...t,keyframes:[...n].reverse(),velocity:-a})),null===l.calculatedDuration&&(l.calculatedDuration=Je(l));const{calculatedDuration:d}=l;this.calculatedDuration=d,this.resolvedDuration=d+s,this.totalDuration=this.resolvedDuration*(i+1)-s,this.generator=l}updateTime(t){const e=Math.round(t-this.startTime)*this.playbackSpeed;null!==this.holdTime?this.currentTime=this.holdTime:this.currentTime=e}tick(t,e=!1){const{generator:i,totalDuration:s,mixKeyframes:r,mirroredGenerator:a,resolvedDuration:n,calculatedDuration:o}=this;if(null===this.startTime)return i.next(0);const{delay:l=0,keyframes:d,repeat:c,repeatType:p,repeatDelay:h,type:u,onUpdate:g,finalKeyframe:m}=this.options;this.speed>0?this.startTime=Math.min(this.startTime,t):this.speed<0&&(this.startTime=Math.min(t-s/this.speed,this.startTime)),e?this.currentTime=t:this.updateTime(t);const v=this.currentTime-l*(this.playbackSpeed>=0?1:-1),f=this.playbackSpeed>=0?v<0:v>s;this.currentTime=Math.max(v,0),"finished"===this.state&&null===this.holdTime&&(this.currentTime=s);let b,x=this.currentTime,y=i;if(c){const t=Math.min(this.currentTime,s)/n;let e=Math.floor(t),i=t%1;!i&&t>=1&&(i=1),1===i&&e--,e=Math.min(e,c+1);Boolean(e%2)&&("reverse"===p?(i=1-i,h&&(i-=h/n)):"mirror"===p&&(y=a)),x=pt(0,1,i)*n}f?(this.delayState.value=d[0],b=this.delayState):b=y.next(x),r&&!f&&(b.value=r(b.value));let{done:_}=b;f||null===o||(_=this.playbackSpeed>=0?this.currentTime>=s:this.currentTime<=0);const w=null===this.holdTime&&("finished"===this.state||"running"===this.state&&_);return w&&u!==yi&&(b.value=Mi(d,this.options,m,this.speed)),g&&g(b.value),w&&this.finish(),b}then(t,e){return this.finished.then(t,e)}get duration(){return St(this.calculatedDuration)}get iterationDuration(){const{delay:t=0}=this.options||{};return this.duration+St(t)}get time(){return St(this.currentTime)}set time(t){t=kt(t),this.currentTime=t,null===this.startTime||null!==this.holdTime||0===this.playbackSpeed?this.holdTime=t:this.driver&&(this.startTime=this.driver.now()-t/this.playbackSpeed),this.driver?this.driver.start(!1):(this.startTime=0,this.state="paused",this.holdTime=t,this.tick(t))}getGeneratorVelocity(){const t=this.currentTime;if(t<=0)return this.options.velocity||0;if(this.generator.velocity)return this.generator.velocity(t);return xi(t=>this.generator.next(t).value,t,this.generator.next(t).value)}get speed(){return this.playbackSpeed}set speed(t){const e=this.playbackSpeed!==t;e&&this.driver&&this.updateTime(Qt.now()),this.playbackSpeed=t,e&&this.driver&&(this.time=St(this.currentTime))}play(){if(this.isStopped)return;const{driver:t=Ye,startTime:e}=this.options;this.driver||(this.driver=t(t=>this.tick(t))),this.options.onPlay?.();const i=this.driver.now();"finished"===this.state?(this.updateFinished(),this.startTime=i):null!==this.holdTime?this.startTime=i-this.holdTime:this.startTime||(this.startTime=e??i),"finished"===this.state&&this.speed<0&&(this.startTime+=this.calculatedDuration),this.holdTime=null,this.state="running",this.driver.start()}pause(){this.state="paused",this.updateTime(Qt.now()),this.holdTime=this.currentTime}complete(){"running"!==this.state&&this.play(),this.state="finished",this.holdTime=null}finish(){this.notifyFinished(),this.teardown(),this.state="finished",this.options.onComplete?.()}cancel(){this.holdTime=null,this.startTime=0,this.tick(0),this.teardown(),this.options.onCancel?.()}teardown(){this.state="idle",this.stopDriver(),this.startTime=this.holdTime=null}stopDriver(){this.driver&&(this.driver.stop(),this.driver=void 0)}sample(t){return this.startTime=0,this.tick(t,!0)}attachTimeline(t){return this.options.allowFlatten&&(this.options.type="keyframes",this.options.ease="linear",this.initAnimation()),this.driver?.stop(),t.observe(this)}}const zi=t=>180*t/Math.PI,Li=t=>{const e=zi(Math.atan2(t[1],t[0]));return Ii(e)},Oi={x:4,y:5,translateX:4,translateY:5,scaleX:0,scaleY:3,scale:t=>(Math.abs(t[0])+Math.abs(t[3]))/2,rotate:Li,rotateZ:Li,skewX:t=>zi(Math.atan(t[1])),skewY:t=>zi(Math.atan(t[2])),skew:t=>(Math.abs(t[1])+Math.abs(t[2]))/2},Ii=t=>((t%=360)<0&&(t+=360),t),Di=t=>Math.sqrt(t[0]*t[0]+t[1]*t[1]),Fi=t=>Math.sqrt(t[4]*t[4]+t[5]*t[5]),Ni={x:12,y:13,z:14,translateX:12,translateY:13,translateZ:14,scaleX:Di,scaleY:Fi,scale:t=>(Di(t)+Fi(t))/2,rotateX:t=>Ii(zi(Math.atan2(t[6],t[5]))),rotateY:t=>Ii(zi(Math.atan2(-t[2],t[0]))),rotateZ:Li,rotate:Li,skewX:t=>zi(Math.atan(t[4])),skewY:t=>zi(Math.atan(t[1])),skew:t=>(Math.abs(t[1])+Math.abs(t[4]))/2};function Bi(t){return t.includes("scale")?1:0}function Ri(t,e){if(!t||"none"===t)return Bi(e);const i=t.match(/^matrix3d\(([-\d.e\s,]+)\)$/u);let s,r;if(i)s=Ni,r=i;else{const e=t.match(/^matrix\(([-\d.e\s,]+)\)$/u);s=Oi,r=e}if(!r)return Bi(e);const a=s[e],n=r[1].split(",").map(Vi);return"function"==typeof a?a(n):n[a]}function Vi(t){return parseFloat(t.trim())}const ji=["transformPerspective","x","y","z","translateX","translateY","translateZ","scale","scaleX","scaleY","rotate","rotateX","rotateY","rotateZ","skew","skewX","skewY"],Gi=(()=>new Set(ji))(),qi=t=>t===ne||t===ye,Ui=new Set(["x","y","z"]),Wi=ji.filter(t=>!Ui.has(t));const Hi={width:({x:t},{paddingLeft:e="0",paddingRight:i="0",boxSizing:s})=>{const r=t.max-t.min;return"border-box"===s?r:r-parseFloat(e)-parseFloat(i)},height:({y:t},{paddingTop:e="0",paddingBottom:i="0",boxSizing:s})=>{const r=t.max-t.min;return"border-box"===s?r:r-parseFloat(e)-parseFloat(i)},top:(t,{top:e})=>parseFloat(e),left:(t,{left:e})=>parseFloat(e),bottom:({y:t},{top:e})=>parseFloat(e)+(t.max-t.min),right:({x:t},{left:e})=>parseFloat(e)+(t.max-t.min),x:(t,{transform:e})=>Ri(e,"x"),y:(t,{transform:e})=>Ri(e,"y")};Hi.translateX=Hi.x,Hi.translateY=Hi.y;const Yi=new Set;let Xi=!1,Ki=!1,Ji=!1;function Zi(){if(Ki){const t=Array.from(Yi).filter(t=>t.needsMeasurement),e=new Set(t.map(t=>t.element)),i=new Map;e.forEach(t=>{const e=function(t){const e=[];return Wi.forEach(i=>{const s=t.getValue(i);void 0!==s&&(e.push([i,s.get()]),s.set(i.startsWith("scale")?1:0))}),e}(t);e.length&&(i.set(t,e),t.render())}),t.forEach(t=>t.measureInitialState()),e.forEach(t=>{t.render();const e=i.get(t);e&&e.forEach(([e,i])=>{t.getValue(e)?.set(i)})}),t.forEach(t=>t.measureEndState()),t.forEach(t=>{void 0!==t.suspendedScrollY&&window.scrollTo(0,t.suspendedScrollY)})}Ki=!1,Xi=!1,Yi.forEach(t=>t.complete(Ji)),Yi.clear()}function Qi(){Yi.forEach(t=>{t.readKeyframes(),t.needsMeasurement&&(Ki=!0)})}class ts{constructor(t,e,i,s,r,a=!1){this.state="pending",this.isAsync=!1,this.needsMeasurement=!1,this.unresolvedKeyframes=[...t],this.onComplete=e,this.name=i,this.motionValue=s,this.element=r,this.isAsync=a}scheduleResolve(){this.state="scheduled",this.isAsync?(Yi.add(this),Xi||(Xi=!0,Yt.read(Qi),Yt.resolveKeyframes(Zi))):(this.readKeyframes(),this.complete())}readKeyframes(){const{unresolvedKeyframes:t,name:e,element:i,motionValue:s}=this;if(null===t[0]){const r=s?.get(),a=t[t.length-1];if(void 0!==r)t[0]=r;else if(i&&e){const s=i.readValue(e,a);null!=s&&(t[0]=s)}void 0===t[0]&&(t[0]=a),s&&void 0===r&&s.set(t[0])}!function(t){for(let e=1;e<t.length;e++)t[e]??(t[e]=t[e-1])}(t)}setFinalKeyframe(){}measureInitialState(){}renderEndStyles(){}measureEndState(){}complete(t=!1){this.state="complete",this.onComplete(this.unresolvedKeyframes,this.finalKeyframe,t),Yi.delete(this)}cancel(){"scheduled"===this.state&&(Yi.delete(this),this.state="pending")}resume(){"pending"===this.state&&this.scheduleResolve()}}function es(t,e,i){(t=>t.startsWith("--"))(e)?t.style.setProperty(e,i):t.style[e]=i}const is={};function ss(t,e){const i=bt(t);return()=>is[e]??i()}const rs=ss(()=>void 0!==window.ScrollTimeline,"scrollTimeline"),as=ss(()=>{try{document.createElement("div").animate({opacity:0},{easing:"linear(0, 1)"})}catch(t){return!1}return!0},"linearEasing"),ns=([t,e,i,s])=>`cubic-bezier(${t}, ${e}, ${i}, ${s})`,os={linear:"linear",ease:"ease",easeIn:"ease-in",easeOut:"ease-out",easeInOut:"ease-in-out",circIn:ns([0,.65,.55,1]),circOut:ns([.55,0,1,.45]),backIn:ns([.31,.01,.66,-.59]),backOut:ns([.33,1.53,.69,.99])};function ls(t,e){return t?"function"==typeof t?as()?Xe(t,e):"ease-out":Gt(t)?ns(t):Array.isArray(t)?t.map(t=>ls(t,e)||os.easeOut):os[t]:void 0}function ds(t,e,i,{delay:s=0,duration:r=300,repeat:a=0,repeatType:n="loop",ease:o="easeOut",times:l}={},d=void 0){const c={[e]:i};l&&(c.offset=l);const p=ls(o,r);Array.isArray(p)&&(c.easing=p);const h={delay:s,duration:r,easing:Array.isArray(p)?"linear":p,fill:"both",iterations:a+1,direction:"reverse"===n?"alternate":"normal"};d&&(h.pseudoElement=d);return t.animate(c,h)}function cs(t){return"function"==typeof t&&"applyToOptions"in t}class ps extends Ei{constructor(t){if(super(),this.finishedTime=null,this.isStopped=!1,this.manualStartTime=null,!t)return;const{element:e,name:i,keyframes:s,pseudoElement:r,allowFlatten:a=!1,finalKeyframe:n,onComplete:o}=t;this.isPseudoElement=Boolean(r),this.allowFlatten=a,this.options=t,gt("string"!=typeof t.type,'Mini animate() doesn\'t support "type" as a string.',"mini-spring");const l=function({type:t,...e}){return cs(t)&&as()?t.applyToOptions(e):(e.duration??(e.duration=300),e.ease??(e.ease="easeOut"),e)}(t);this.animation=ds(e,i,s,l,r),!1===l.autoplay&&this.animation.pause(),this.animation.onfinish=()=>{if(this.finishedTime=this.time,!r){const t=Mi(s,this.options,n,this.speed);this.updateMotionValue&&this.updateMotionValue(t),es(e,i,t),this.animation.cancel()}o?.(),this.notifyFinished()}}play(){this.isStopped||(this.manualStartTime=null,this.animation.play(),"finished"===this.state&&this.updateFinished())}pause(){this.animation.pause()}complete(){this.animation.finish?.()}cancel(){try{this.animation.cancel()}catch(t){}}stop(){if(this.isStopped)return;this.isStopped=!0;const{state:t}=this;"idle"!==t&&"finished"!==t&&(this.updateMotionValue?this.updateMotionValue():this.commitStyles(),this.isPseudoElement||this.cancel())}commitStyles(){const t=this.options?.element;!this.isPseudoElement&&t?.isConnected&&this.animation.commitStyles?.()}get duration(){const t=this.animation.effect?.getComputedTiming?.().duration||0;return St(Number(t))}get iterationDuration(){const{delay:t=0}=this.options||{};return this.duration+St(t)}get time(){return St(Number(this.animation.currentTime)||0)}set time(t){const e=null!==this.finishedTime;this.manualStartTime=null,this.finishedTime=null,this.animation.currentTime=kt(t),e&&this.animation.pause()}get speed(){return this.animation.playbackRate}set speed(t){t<0&&(this.finishedTime=null),this.animation.playbackRate=t}get state(){return null!==this.finishedTime?"finished":this.animation.playState}get startTime(){return this.manualStartTime??Number(this.animation.startTime)}set startTime(t){this.manualStartTime=this.animation.startTime=t}attachTimeline({timeline:t,rangeStart:e,rangeEnd:i,observe:s}){return this.allowFlatten&&this.animation.effect?.updateTiming({easing:"linear"}),this.animation.onfinish=null,t&&rs()?(this.animation.timeline=t,e&&(this.animation.rangeStart=e),i&&(this.animation.rangeEnd=i),xt):s(this)}}const hs={anticipate:Ot,backInOut:Lt,circInOut:Ft};function us(t){"string"==typeof t.ease&&t.ease in hs&&(t.ease=hs[t.ease])}class gs extends ps{constructor(t){us(t),Ci(t),super(t),void 0!==t.startTime&&!1!==t.autoplay&&(this.startTime=t.startTime),this.options=t}updateMotionValue(t){const{motionValue:e,onUpdate:i,onComplete:s,element:r,...a}=this.options;if(!e)return;if(void 0!==t)return void e.set(t);const n=new Ai({...a,autoplay:!1}),o=Math.max(10,Qt.now()-this.startTime),l=pt(0,10,o-10),d=n.sample(o).value,{name:c}=this.options;r&&c&&es(r,c,d),e.setWithVelocity(n.sample(Math.max(0,o-l)).value,d,l),n.stop()}}const ms=(t,e)=>"zIndex"!==e&&(!("number"!=typeof t&&!Array.isArray(t))||!("string"!=typeof t||!Le.test(t)&&"0"!==t||t.startsWith("url(")));function vs(t){t.duration=0,t.type="keyframes"}const fs=new Set(["opacity","clipPath","filter","transform"]),bs=/^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/;const xs=new Set(["color","backgroundColor","outlineColor","fill","stroke","borderColor","borderTopColor","borderRightColor","borderBottomColor","borderLeftColor"]),ys=bt(()=>Object.hasOwnProperty.call(Element.prototype,"animate"));function _s(t){const{motionValue:e,name:i,repeatDelay:s,repeatType:r,damping:a,type:n,keyframes:o}=t,l=e?.owner?.current;if(!(l instanceof HTMLElement))return!1;const{onUpdate:d,transformTemplate:c}=e.owner.getProps();return ys()&&i&&(fs.has(i)||xs.has(i)&&function(t){for(let e=0;e<t.length;e++)if("string"==typeof t[e]&&bs.test(t[e]))return!0;return!1}(o))&&("transform"!==i||!c)&&!d&&!s&&"mirror"!==r&&0!==a&&"inertia"!==n}class ws extends Ei{constructor({autoplay:t=!0,delay:e=0,type:i="keyframes",repeat:s=0,repeatDelay:r=0,repeatType:a="loop",keyframes:n,name:o,motionValue:l,element:d,...c}){super(),this.stop=()=>{this._animation&&(this._animation.stop(),this.stopTimeline?.()),this.keyframeResolver?.cancel()},this.createdAt=Qt.now();const p={autoplay:t,delay:e,type:i,repeat:s,repeatDelay:r,repeatType:a,name:o,motionValue:l,element:d,...c},h=d?.KeyframeResolver||ts;this.keyframeResolver=new h(n,(t,e,i)=>this.onKeyframesResolved(t,e,p,!i),o,l,d),this.keyframeResolver?.scheduleResolve()}onKeyframesResolved(t,e,i,s){this.keyframeResolver=void 0;const{name:r,type:a,velocity:n,delay:o,isHandoff:l,onUpdate:d}=i;this.resolvedAt=Qt.now();let c=!0;(function(t,e,i,s){const r=t[0];if(null===r)return!1;if("display"===e||"visibility"===e)return!0;const a=t[t.length-1],n=ms(r,e),o=ms(a,e);return ut(n===o,`You are trying to animate ${e} from "${r}" to "${a}". "${n?a:r}" is not an animatable value.`,"value-not-animatable"),!(!n||!o)&&(function(t){const e=t[0];if(1===t.length)return!0;for(let i=0;i<t.length;i++)if(t[i]!==e)return!0}(t)||("spring"===i||cs(i))&&s)})(t,r,a,n)||(c=!1,!mt.instantAnimations&&o||d?.(Mi(t,i,e)),t[0]=t[t.length-1],vs(i),i.repeat=0);const p={startTime:s?this.resolvedAt&&this.resolvedAt-this.createdAt>40?this.resolvedAt:this.createdAt:void 0,finalKeyframe:e,...i,keyframes:t},h=c&&!l&&_s(p),u=p.motionValue?.owner?.current;let g;if(h)try{g=new gs({...p,element:u})}catch{g=new Ai(p)}else g=new Ai(p);g.finished.then(()=>{this.notifyFinished()}).catch(xt),this.pendingTimeline&&(this.stopTimeline=g.attachTimeline(this.pendingTimeline),this.pendingTimeline=void 0),this._animation=g}get finished(){return this._animation?this.animation.finished:this._finished}then(t,e){return this.finished.finally(t).then(()=>{})}get animation(){return this._animation||(this.keyframeResolver?.resume(),Ji=!0,Qi(),Zi(),Ji=!1),this._animation}get duration(){return this.animation.duration}get iterationDuration(){return this.animation.iterationDuration}get time(){return this.animation.time}set time(t){this.animation.time=t}get speed(){return this.animation.speed}get state(){return this.animation.state}set speed(t){this.animation.speed=t}get startTime(){return this.animation.startTime}attachTimeline(t){return this._animation?this.stopTimeline=this.animation.attachTimeline(t):this.pendingTimeline=t,()=>this.stop()}play(){this.animation.play()}pause(){this.animation.pause()}complete(){this.animation.complete()}cancel(){this._animation&&this.animation.cancel(),this.keyframeResolver?.cancel()}}class $s{constructor(t){this.stop=()=>this.runAll("stop"),this.animations=t.filter(Boolean)}get finished(){return Promise.all(this.animations.map(t=>t.finished))}getAll(t){return this.animations[0][t]}setAll(t,e){for(let i=0;i<this.animations.length;i++)this.animations[i][t]=e}attachTimeline(t){const e=this.animations.map(e=>e.attachTimeline(t));return()=>{e.forEach((t,e)=>{t&&t(),this.animations[e].stop()})}}get time(){return this.getAll("time")}set time(t){this.setAll("time",t)}get speed(){return this.getAll("speed")}set speed(t){this.setAll("speed",t)}get state(){return this.getAll("state")}get startTime(){return this.getAll("startTime")}get duration(){return ks(this.animations,"duration")}get iterationDuration(){return ks(this.animations,"iterationDuration")}runAll(t){this.animations.forEach(e=>e[t]())}play(){this.runAll("play")}pause(){this.runAll("pause")}cancel(){this.runAll("cancel")}complete(){this.runAll("complete")}}function ks(t,e){let i=0;for(let s=0;s<t.length;s++){const r=t[s][e];null!==r&&r>i&&(i=r)}return i}class Ss extends $s{then(t,e){return this.finished.finally(t).then(()=>{})}}const Ms=/^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u;function Ts(t,e,i=1){gt(i<=4,`Max CSS variable fallback depth detected in property "${t}". This may indicate a circular fallback dependency.`,"max-css-var-depth");const[s,r]=function(t){const e=Ms.exec(t);if(!e)return[,];const[,i,s,r]=e;return[`--${i??s}`,r]}(t);if(!s)return;const a=window.getComputedStyle(e).getPropertyValue(s);if(a){const t=a.trim();return vt(t)?parseFloat(t):t}return se(r)?Ts(r,e,i+1):r}const Cs={type:"spring",stiffness:500,damping:25,restSpeed:10},Es={type:"keyframes",duration:.8},Ps={type:"keyframes",ease:[.25,.1,.35,1],duration:.3},As=(t,{keyframes:e})=>e.length>2?Es:Gi.has(t)?t.startsWith("scale")?{type:"spring",stiffness:550,damping:0===e[1]?2*Math.sqrt(550):30,restSpeed:10}:Cs:Ps;function zs(t,e){if(t?.inherit&&e){const{inherit:i,...s}=t;return{...e,...s}}return t}function Ls(t,e){const i=t?.[e]??t?.default??t;return i!==t?zs(i,t):i}const Os=new Set(["when","delay","delayChildren","staggerChildren","staggerDirection","repeat","repeatType","repeatDelay","from","elapsed"]);const Is=(t,e,i,s={},r,a)=>n=>{const o=Ls(s,t)||{},l=o.delay||s.delay||0;let{elapsed:d=0}=s;d-=kt(l);const c={keyframes:Array.isArray(i)?i:[null,i],ease:"easeOut",velocity:e.getVelocity(),...o,delay:-d,onUpdate:t=>{e.set(t),o.onUpdate&&o.onUpdate(t)},onComplete:()=>{n(),o.onComplete&&o.onComplete()},name:t,motionValue:e,element:a?void 0:r};(function(t){for(const e in t)if(!Os.has(e))return!0;return!1})(o)||Object.assign(c,As(t,c)),c.duration&&(c.duration=kt(c.duration)),c.repeatDelay&&(c.repeatDelay=kt(c.repeatDelay)),void 0!==c.from&&(c.keyframes[0]=c.from);let p=!1;if((!1===c.type||0===c.duration&&!c.repeatDelay)&&(vs(c),0===c.delay&&(p=!0)),(mt.instantAnimations||mt.skipAnimations||r?.shouldSkipAnimations)&&(p=!0,vs(c),c.delay=0),c.allowFlatten=!o.type&&!o.ease,p&&!a&&void 0!==e.get()){const t=Mi(c.keyframes,o);if(void 0!==t)return void Yt.update(()=>{c.onUpdate(t),c.onComplete()})}return o.isSync?new Ai(c):new ws(c)};function Ds(t){const e=[{},{}];return t?.values.forEach((t,i)=>{e[0][i]=t.get(),e[1][i]=t.getVelocity()}),e}function Fs(t,e,i,s){if("function"==typeof e){const[r,a]=Ds(s);e=e(void 0!==i?i:t.custom,r,a)}if("string"==typeof e&&(e=t.variants&&t.variants[e]),"function"==typeof e){const[r,a]=Ds(s);e=e(void 0!==i?i:t.custom,r,a)}return e}const Ns=new Set(["width","height","top","left","right","bottom",...ji]);class Bs{constructor(t,e={}){this.canTrackVelocity=null,this.events={},this.updateAndNotify=t=>{const e=Qt.now();if(this.updatedAt!==e&&this.setPrevFrameValue(),this.prev=this.current,this.setCurrent(t),this.current!==this.prev&&(this.events.change?.notify(this.current),this.dependents))for(const t of this.dependents)t.dirty()},this.hasAnimated=!1,this.setCurrent(t),this.owner=e.owner}setCurrent(t){var e;this.current=t,this.updatedAt=Qt.now(),null===this.canTrackVelocity&&void 0!==t&&(this.canTrackVelocity=(e=this.current,!isNaN(parseFloat(e))))}setPrevFrameValue(t=this.current){this.prevFrameValue=t,this.prevUpdatedAt=this.updatedAt}onChange(t){return this.on("change",t)}on(t,e){this.events[t]||(this.events[t]=new $t);const i=this.events[t].add(e);return"change"===t?()=>{i(),Yt.read(()=>{this.events.change.getSize()||this.stop()})}:i}clearListeners(){for(const t in this.events)this.events[t].clear()}attach(t,e){this.passiveEffect=t,this.stopPassiveEffect=e}set(t){this.passiveEffect?this.passiveEffect(t,this.updateAndNotify):this.updateAndNotify(t)}setWithVelocity(t,e,i){this.set(e),this.prev=void 0,this.prevFrameValue=t,this.prevUpdatedAt=this.updatedAt-i}jump(t,e=!0){this.updateAndNotify(t),this.prev=t,this.prevUpdatedAt=this.prevFrameValue=void 0,e&&this.stop(),this.stopPassiveEffect&&this.stopPassiveEffect()}dirty(){this.events.change?.notify(this.current)}addDependent(t){this.dependents||(this.dependents=new Set),this.dependents.add(t)}removeDependent(t){this.dependents&&this.dependents.delete(t)}get(){return this.current}getPrevious(){return this.prev}getVelocity(){const t=Qt.now();if(!this.canTrackVelocity||void 0===this.prevFrameValue||t-this.updatedAt>30)return 0;const e=Math.min(this.updatedAt-this.prevUpdatedAt,30);return Mt(parseFloat(this.current)-parseFloat(this.prevFrameValue),e)}start(t){return this.stop(),new Promise(e=>{this.hasAnimated=!0,this.animation=t(e),this.events.animationStart&&this.events.animationStart.notify()}).then(()=>{this.events.animationComplete&&this.events.animationComplete.notify(),this.clearAnimation()})}stop(){this.animation&&(this.animation.stop(),this.events.animationCancel&&this.events.animationCancel.notify()),this.clearAnimation()}isAnimating(){return!!this.animation}clearAnimation(){delete this.animation}destroy(){this.dependents?.clear(),this.events.destroy?.notify(),this.clearListeners(),this.stop(),this.stopPassiveEffect&&this.stopPassiveEffect()}}function Rs(t,e){return new Bs(t,e)}function Vs(t,e,i){t.hasValue(e)?t.getValue(e).set(i):t.addValue(e,Rs(i))}function js(t){return(t=>Array.isArray(t))(t)?t[t.length-1]||0:t}function Gs(t,e){const i=function(t,e){const i=t.getProps();return Fs(i,e,i.custom,t)}(t,e);let{transitionEnd:s={},transition:r={},...a}=i||{};a={...a,...s};for(const e in a){Vs(t,e,js(a[e]))}}const qs=t=>Boolean(t&&t.getVelocity);function Us(t,e){const i=t.getValue("willChange");if(s=i,Boolean(qs(s)&&s.add))return i.add(e);if(!i&&mt.WillChange){const i=new mt.WillChange("auto");t.addValue("willChange",i),i.add(e)}var s}function Ws(t){return t.replace(/([A-Z])/g,t=>`-${t.toLowerCase()}`)}const Hs="data-"+Ws("framerAppearId");function Ys(t){return t.props[Hs]}function Xs({protectedKeys:t,needsAnimating:e},i){const s=t.hasOwnProperty(i)&&!0!==e[i];return e[i]=!1,s}function Ks(t,e,{delay:i=0,transitionOverride:s,type:r}={}){let{transition:a,transitionEnd:n,...o}=e;const l=t.getDefaultTransition();a=a?zs(a,l):l;const d=a?.reduceMotion;s&&(a=s);const c=[],p=r&&t.animationState&&t.animationState.getState()[r];for(const e in o){const s=t.getValue(e,t.latestValues[e]??null),r=o[e];if(void 0===r||p&&Xs(p,e))continue;const n={delay:i,...Ls(a||{},e)},l=s.get();if(void 0!==l&&!s.isAnimating()&&!Array.isArray(r)&&r===l&&!n.velocity){Yt.update(()=>s.set(r));continue}let h=!1;if(window.MotionHandoffAnimation){const i=Ys(t);if(i){const t=window.MotionHandoffAnimation(i,e,Yt);null!==t&&(n.startTime=t,h=!0)}}Us(t,e);const u=d??t.shouldReduceMotion;s.start(Is(e,s,r,u&&Ns.has(e)?{type:!1}:n,t,h));const g=s.animation;g&&c.push(g)}if(n){const e=()=>Yt.update(()=>{n&&Gs(t,n)});c.length?Promise.all(c).then(e):e()}return c}const Js=t=>e=>e.test(t),Zs=[ne,ye,xe,be,we,_e,{test:t=>"auto"===t,parse:t=>t}],Qs=t=>Zs.find(Js(t));function tr(t){return"number"==typeof t?0===t:null===t||("none"===t||"0"===t||ft(t))}const er=new Set(["brightness","contrast","saturate","opacity"]);function ir(t){const[e,i]=t.slice(0,-1).split("(");if("drop-shadow"===e)return t;const[s]=i.match(ce)||[];if(!s)return t;const r=i.replace(s,"");let a=er.has(e)?1:0;return s!==i&&(a*=100),e+"("+a+r+")"}const sr=/\b([a-z-]*)\(.*?\)/gu,rr={...Le,getAnimatableNone:t=>{const e=t.match(sr);return e?e.map(ir).join(" "):t}},ar={...Le,getAnimatableNone:t=>{const e=Le.parse(t);return Le.createTransformer(t)(e.map(t=>"number"==typeof t?0:"object"==typeof t?{...t,alpha:1}:t))}},nr={...ne,transform:Math.round},or={borderWidth:ye,borderTopWidth:ye,borderRightWidth:ye,borderBottomWidth:ye,borderLeftWidth:ye,borderRadius:ye,borderTopLeftRadius:ye,borderTopRightRadius:ye,borderBottomRightRadius:ye,borderBottomLeftRadius:ye,width:ye,maxWidth:ye,height:ye,maxHeight:ye,top:ye,right:ye,bottom:ye,left:ye,inset:ye,insetBlock:ye,insetBlockStart:ye,insetBlockEnd:ye,insetInline:ye,insetInlineStart:ye,insetInlineEnd:ye,padding:ye,paddingTop:ye,paddingRight:ye,paddingBottom:ye,paddingLeft:ye,paddingBlock:ye,paddingBlockStart:ye,paddingBlockEnd:ye,paddingInline:ye,paddingInlineStart:ye,paddingInlineEnd:ye,margin:ye,marginTop:ye,marginRight:ye,marginBottom:ye,marginLeft:ye,marginBlock:ye,marginBlockStart:ye,marginBlockEnd:ye,marginInline:ye,marginInlineStart:ye,marginInlineEnd:ye,fontSize:ye,backgroundPositionX:ye,backgroundPositionY:ye,...{rotate:be,rotateX:be,rotateY:be,rotateZ:be,scale:le,scaleX:le,scaleY:le,scaleZ:le,skew:be,skewX:be,skewY:be,distance:ye,translateX:ye,translateY:ye,translateZ:ye,x:ye,y:ye,z:ye,perspective:ye,transformPerspective:ye,opacity:oe,originX:$e,originY:$e,originZ:ye},zIndex:nr,fillOpacity:oe,strokeOpacity:oe,numOctaves:nr},lr={...or,color:Se,backgroundColor:Se,outlineColor:Se,fill:Se,stroke:Se,borderColor:Se,borderTopColor:Se,borderRightColor:Se,borderBottomColor:Se,borderLeftColor:Se,filter:rr,WebkitFilter:rr,mask:ar,WebkitMask:ar},dr=t=>lr[t],cr=new Set([rr,ar]);function pr(t,e){let i=dr(t);return cr.has(i)||(i=Le),i.getAnimatableNone?i.getAnimatableNone(e):void 0}const hr=new Set(["auto","none","0"]);class ur extends ts{constructor(t,e,i,s,r){super(t,e,i,s,r,!0)}readKeyframes(){const{unresolvedKeyframes:t,element:e,name:i}=this;if(!e||!e.current)return;super.readKeyframes();for(let i=0;i<t.length;i++){let s=t[i];if("string"==typeof s&&(s=s.trim(),se(s))){const r=Ts(s,e.current);void 0!==r&&(t[i]=r),i===t.length-1&&(this.finalKeyframe=s)}}if(this.resolveNoneKeyframes(),!Ns.has(i)||2!==t.length)return;const[s,r]=t,a=Qs(s),n=Qs(r);if(ae(s)!==ae(r)&&Hi[i])this.needsMeasurement=!0;else if(a!==n)if(qi(a)&&qi(n))for(let e=0;e<t.length;e++){const i=t[e];"string"==typeof i&&(t[e]=parseFloat(i))}else Hi[i]&&(this.needsMeasurement=!0)}resolveNoneKeyframes(){const{unresolvedKeyframes:t,name:e}=this,i=[];for(let e=0;e<t.length;e++)(null===t[e]||tr(t[e]))&&i.push(e);i.length&&function(t,e,i){let s,r=0;for(;r<t.length&&!s;){const e=t[r];"string"==typeof e&&!hr.has(e)&&Pe(e).values.length&&(s=t[r]),r++}if(s&&i)for(const r of e)t[r]=pr(i,s)}(t,i,e)}measureInitialState(){const{element:t,unresolvedKeyframes:e,name:i}=this;if(!t||!t.current)return;"height"===i&&(this.suspendedScrollY=window.pageYOffset),this.measuredOrigin=Hi[i](t.measureViewportBox(),window.getComputedStyle(t.current)),e[0]=this.measuredOrigin;const s=e[e.length-1];void 0!==s&&t.getValue(i,s).jump(s,!1)}measureEndState(){const{element:t,name:e,unresolvedKeyframes:i}=this;if(!t||!t.current)return;const s=t.getValue(e);s&&s.jump(this.measuredOrigin,!1);const r=i.length-1,a=i[r];i[r]=Hi[e](t.measureViewportBox(),window.getComputedStyle(t.current)),null!==a&&void 0===this.finalKeyframe&&(this.finalKeyframe=a),this.removedTransforms?.length&&this.removedTransforms.forEach(([e,i])=>{t.getValue(e).set(i)}),this.resolveNoneKeyframes()}}const gr=(t,e)=>e&&"number"==typeof t?e.transform(t):t,{schedule:mr}=Ht(queueMicrotask,!1);function vr(t){return"object"==typeof(e=t)&&null!==e&&"ownerSVGElement"in t;var e}const fr=[...Zs,Se,Le],br=()=>({x:{min:0,max:0},y:{min:0,max:0}}),xr=new WeakMap;const yr=["initial","animate","whileInView","whileFocus","whileHover","whileTap","whileDrag","exit"];function _r(t){return function(t){return null!==t&&"object"==typeof t&&"function"==typeof t.start}(t.animate)||yr.some(e=>function(t){return"string"==typeof t||Array.isArray(t)}(t[e]))}const wr={current:null},$r={current:!1},kr="undefined"!=typeof window;const Sr=["AnimationStart","AnimationComplete","Update","BeforeLayoutMeasure","LayoutMeasure","LayoutAnimationStart","LayoutAnimationComplete"];let Mr={};class Tr{scrapeMotionValuesFromProps(t,e,i){return{}}constructor({parent:t,props:e,presenceContext:i,reducedMotionConfig:s,skipAnimations:r,blockInitialAnimation:a,visualState:n},o={}){this.current=null,this.children=new Set,this.isVariantNode=!1,this.isControllingVariants=!1,this.shouldReduceMotion=null,this.shouldSkipAnimations=!1,this.values=new Map,this.KeyframeResolver=ts,this.features={},this.valueSubscriptions=new Map,this.prevMotionValues={},this.hasBeenMounted=!1,this.events={},this.propEventSubscriptions={},this.notifyUpdate=()=>this.notify("Update",this.latestValues),this.render=()=>{this.current&&(this.triggerBuild(),this.renderInstance(this.current,this.renderState,this.props.style,this.projection))},this.renderScheduledAt=0,this.scheduleRender=()=>{const t=Qt.now();this.renderScheduledAt<t&&(this.renderScheduledAt=t,Yt.render(this.render,!1,!0))};const{latestValues:l,renderState:d}=n;this.latestValues=l,this.baseTarget={...l},this.initialValues=e.initial?{...l}:{},this.renderState=d,this.parent=t,this.props=e,this.presenceContext=i,this.depth=t?t.depth+1:0,this.reducedMotionConfig=s,this.skipAnimationsConfig=r,this.options=o,this.blockInitialAnimation=Boolean(a),this.isControllingVariants=_r(e),this.isVariantNode=function(t){return Boolean(_r(t)||t.variants)}(e),this.isVariantNode&&(this.variantChildren=new Set),this.manuallyAnimateOnMount=Boolean(t&&t.current);const{willChange:c,...p}=this.scrapeMotionValuesFromProps(e,{},this);for(const t in p){const e=p[t];void 0!==l[t]&&qs(e)&&e.set(l[t])}}mount(t){if(this.hasBeenMounted)for(const t in this.initialValues)this.values.get(t)?.jump(this.initialValues[t]),this.latestValues[t]=this.initialValues[t];this.current=t,xr.set(t,this),this.projection&&!this.projection.instance&&this.projection.mount(t),this.parent&&this.isVariantNode&&!this.isControllingVariants&&(this.removeFromVariantTree=this.parent.addVariantChild(this)),this.values.forEach((t,e)=>this.bindToMotionValue(e,t)),"never"===this.reducedMotionConfig?this.shouldReduceMotion=!1:"always"===this.reducedMotionConfig?this.shouldReduceMotion=!0:($r.current||function(){if($r.current=!0,kr)if(window.matchMedia){const t=window.matchMedia("(prefers-reduced-motion)"),e=()=>wr.current=t.matches;t.addEventListener("change",e),e()}else wr.current=!1}(),this.shouldReduceMotion=wr.current),this.shouldSkipAnimations=this.skipAnimationsConfig??!1,this.parent?.addChild(this),this.update(this.props,this.presenceContext),this.hasBeenMounted=!0}unmount(){this.projection&&this.projection.unmount(),Xt(this.notifyUpdate),Xt(this.render),this.valueSubscriptions.forEach(t=>t()),this.valueSubscriptions.clear(),this.removeFromVariantTree&&this.removeFromVariantTree(),this.parent?.removeChild(this);for(const t in this.events)this.events[t].clear();for(const t in this.features){const e=this.features[t];e&&(e.unmount(),e.isMounted=!1)}this.current=null}addChild(t){this.children.add(t),this.enteringChildren??(this.enteringChildren=new Set),this.enteringChildren.add(t)}removeChild(t){this.children.delete(t),this.enteringChildren&&this.enteringChildren.delete(t)}bindToMotionValue(t,e){if(this.valueSubscriptions.has(t)&&this.valueSubscriptions.get(t)(),e.accelerate&&fs.has(t)&&this.current instanceof HTMLElement){const{factory:i,keyframes:s,times:r,ease:a,duration:n}=e.accelerate,o=new ps({element:this.current,name:t,keyframes:s,times:r,ease:a,duration:kt(n)}),l=i(o);return void this.valueSubscriptions.set(t,()=>{l(),o.cancel()})}const i=Gi.has(t);i&&this.onBindTransform&&this.onBindTransform();const s=e.on("change",e=>{this.latestValues[t]=e,this.props.onUpdate&&Yt.preRender(this.notifyUpdate),i&&this.projection&&(this.projection.isTransformDirty=!0),this.scheduleRender()});let r;"undefined"!=typeof window&&window.MotionCheckAppearSync&&(r=window.MotionCheckAppearSync(this,t,e)),this.valueSubscriptions.set(t,()=>{s(),r&&r(),e.owner&&e.stop()})}sortNodePosition(t){return this.current&&this.sortInstanceNodePosition&&this.type===t.type?this.sortInstanceNodePosition(this.current,t.current):0}updateFeatures(){let t="animation";for(t in Mr){const e=Mr[t];if(!e)continue;const{isEnabled:i,Feature:s}=e;if(!this.features[t]&&s&&i(this.props)&&(this.features[t]=new s(this)),this.features[t]){const e=this.features[t];e.isMounted?e.update():(e.mount(),e.isMounted=!0)}}}triggerBuild(){this.build(this.renderState,this.latestValues,this.props)}measureViewportBox(){return this.current?this.measureInstanceViewportBox(this.current,this.props):{x:{min:0,max:0},y:{min:0,max:0}}}getStaticValue(t){return this.latestValues[t]}setStaticValue(t,e){this.latestValues[t]=e}update(t,e){(t.transformTemplate||this.props.transformTemplate)&&this.scheduleRender(),this.prevProps=this.props,this.props=t,this.prevPresenceContext=this.presenceContext,this.presenceContext=e;for(let e=0;e<Sr.length;e++){const i=Sr[e];this.propEventSubscriptions[i]&&(this.propEventSubscriptions[i](),delete this.propEventSubscriptions[i]);const s=t["on"+i];s&&(this.propEventSubscriptions[i]=this.on(i,s))}this.prevMotionValues=function(t,e,i){for(const s in e){const r=e[s],a=i[s];if(qs(r))t.addValue(s,r);else if(qs(a))t.addValue(s,Rs(r,{owner:t}));else if(a!==r)if(t.hasValue(s)){const e=t.getValue(s);!0===e.liveStyle?e.jump(r):e.hasAnimated||e.set(r)}else{const e=t.getStaticValue(s);t.addValue(s,Rs(void 0!==e?e:r,{owner:t}))}}for(const s in i)void 0===e[s]&&t.removeValue(s);return e}(this,this.scrapeMotionValuesFromProps(t,this.prevProps||{},this),this.prevMotionValues),this.handleChildMotionValue&&this.handleChildMotionValue()}getProps(){return this.props}getVariant(t){return this.props.variants?this.props.variants[t]:void 0}getDefaultTransition(){return this.props.transition}getTransformPagePoint(){return this.props.transformPagePoint}getClosestVariantNode(){return this.isVariantNode?this:this.parent?this.parent.getClosestVariantNode():void 0}addVariantChild(t){const e=this.getClosestVariantNode();if(e)return e.variantChildren&&e.variantChildren.add(t),()=>e.variantChildren.delete(t)}addValue(t,e){const i=this.values.get(t);e!==i&&(i&&this.removeValue(t),this.bindToMotionValue(t,e),this.values.set(t,e),this.latestValues[t]=e.get())}removeValue(t){this.values.delete(t);const e=this.valueSubscriptions.get(t);e&&(e(),this.valueSubscriptions.delete(t)),delete this.latestValues[t],this.removeValueFromRenderState(t,this.renderState)}hasValue(t){return this.values.has(t)}getValue(t,e){if(this.props.values&&this.props.values[t])return this.props.values[t];let i=this.values.get(t);return void 0===i&&void 0!==e&&(i=Rs(null===e?void 0:e,{owner:this}),this.addValue(t,i)),i}readValue(t,e){let i=void 0===this.latestValues[t]&&this.current?this.getBaseTargetFromProps(this.props,t)??this.readValueFromInstance(this.current,t,this.options):this.latestValues[t];return null!=i&&("string"==typeof i&&(vt(i)||ft(i))?i=parseFloat(i):!(t=>fr.find(Js(t)))(i)&&Le.test(e)&&(i=pr(t,e)),this.setBaseTarget(t,qs(i)?i.get():i)),qs(i)?i.get():i}setBaseTarget(t,e){this.baseTarget[t]=e}getBaseTarget(t){const{initial:e}=this.props;let i;if("string"==typeof e||"object"==typeof e){const s=Fs(this.props,e,this.presenceContext?.custom);s&&(i=s[t])}if(e&&void 0!==i)return i;const s=this.getBaseTargetFromProps(this.props,t);return void 0===s||qs(s)?void 0!==this.initialValues[t]&&void 0===i?void 0:this.baseTarget[t]:s}on(t,e){return this.events[t]||(this.events[t]=new $t),this.events[t].add(e)}notify(t,...e){this.events[t]&&this.events[t].notify(...e)}scheduleRenderMicrotask(){mr.render(this.render)}}class Cr extends Tr{constructor(){super(...arguments),this.KeyframeResolver=ur}sortInstanceNodePosition(t,e){return 2&t.compareDocumentPosition(e)?1:-1}getBaseTargetFromProps(t,e){const i=t.style;return i?i[e]:void 0}removeValueFromRenderState(t,{vars:e,style:i}){delete e[t],delete i[t]}handleChildMotionValue(){this.childSubscription&&(this.childSubscription(),delete this.childSubscription);const{children:t}=this.props;qs(t)&&(this.childSubscription=t.on("change",t=>{this.current&&(this.current.textContent=`${t}`)}))}}const Er={x:"translateX",y:"translateY",z:"translateZ",transformPerspective:"perspective"},Pr=ji.length;function Ar(t,e,i){const{style:s,vars:r,transformOrigin:a}=t;let n=!1,o=!1;for(const t in e){const i=e[t];if(Gi.has(t))n=!0;else if(ee(t))r[t]=i;else{const e=gr(i,or[t]);t.startsWith("origin")?(o=!0,a[t]=e):s[t]=e}}if(e.transform||(n||i?s.transform=function(t,e,i){let s="",r=!0;for(let a=0;a<Pr;a++){const n=ji[a],o=t[n];if(void 0===o)continue;let l=!0;if("number"==typeof o)l=o===(n.startsWith("scale")?1:0);else{const t=parseFloat(o);l=n.startsWith("scale")?1===t:0===t}if(!l||i){const t=gr(o,or[n]);l||(r=!1,s+=`${Er[n]||n}(${t}) `),i&&(e[n]=t)}}return s=s.trim(),i?s=i(e,r?"":s):r&&(s="none"),s}(e,t.transform,i):s.transform&&(s.transform="none")),o){const{originX:t="50%",originY:e="50%",originZ:i=0}=a;s.transformOrigin=`${t} ${e} ${i}`}}function zr(t,{style:e,vars:i},s,r){const a=t.style;let n;for(n in e)a[n]=e[n];for(n in r?.applyProjectionStyles(a,s),i)a.setProperty(n,i[n])}function Lr(t,e){return e.max===e.min?0:t/(e.max-e.min)*100}const Or={correct:(t,e)=>{if(!e.target)return t;if("string"==typeof t){if(!ye.test(t))return t;t=parseFloat(t)}return`${Lr(t,e.target.x)}% ${Lr(t,e.target.y)}%`}},Ir={correct:(t,{treeScale:e,projectionDelta:i})=>{const s=t,r=Le.parse(t);if(r.length>5)return s;const a=Le.createTransformer(t),n="number"!=typeof r[0]?1:0,o=i.x.scale*e.x,l=i.y.scale*e.y;r[0+n]/=o,r[1+n]/=l;const d=De(o,l,.5);return"number"==typeof r[2+n]&&(r[2+n]/=d),"number"==typeof r[3+n]&&(r[3+n]/=d),a(r)}},Dr={borderRadius:{...Or,applyTo:["borderTopLeftRadius","borderTopRightRadius","borderBottomLeftRadius","borderBottomRightRadius"]},borderTopLeftRadius:Or,borderTopRightRadius:Or,borderBottomLeftRadius:Or,borderBottomRightRadius:Or,boxShadow:Ir};function Fr(t,{layout:e,layoutId:i}){return Gi.has(t)||t.startsWith("origin")||(e||void 0!==i)&&(!!Dr[t]||"opacity"===t)}function Nr(t,e,i){const s=t.style,r=e?.style,a={};if(!s)return a;for(const e in s)(qs(s[e])||r&&qs(r[e])||Fr(e,t)||void 0!==i?.getValue(e)?.liveStyle)&&(a[e]=s[e]);return a}class Br extends Cr{constructor(){super(...arguments),this.type="html",this.renderInstance=zr}readValueFromInstance(t,e){if(Gi.has(e))return this.projection?.isProjecting?Bi(e):((t,e)=>{const{transform:i="none"}=getComputedStyle(t);return Ri(i,e)})(t,e);{const s=(i=t,window.getComputedStyle(i)),r=(ee(e)?s.getPropertyValue(e):s[e])||0;return"string"==typeof r?r.trim():r}var i}measureInstanceViewportBox(t,{transformPagePoint:e}){return function(t,e){return function({top:t,left:e,right:i,bottom:s}){return{x:{min:e,max:i},y:{min:t,max:s}}}(function(t,e){if(!e)return t;const i=e({x:t.left,y:t.top}),s=e({x:t.right,y:t.bottom});return{top:i.y,left:i.x,bottom:s.y,right:s.x}}(t.getBoundingClientRect(),e))}(t,e)}build(t,e,i){Ar(t,e,i.transformTemplate)}scrapeMotionValuesFromProps(t,e,i){return Nr(t,e,i)}}class Rr extends Tr{constructor(){super(...arguments),this.type="object"}readValueFromInstance(t,e){if(function(t,e){return t in e}(e,t)){const i=t[e];if("string"==typeof i||"number"==typeof i)return i}}getBaseTargetFromProps(){}removeValueFromRenderState(t,e){delete e.output[t]}measureInstanceViewportBox(){return{x:{min:0,max:0},y:{min:0,max:0}}}build(t,e){Object.assign(t.output,e)}renderInstance(t,{output:e}){Object.assign(t,e)}sortInstanceNodePosition(){return 0}}const Vr={offset:"stroke-dashoffset",array:"stroke-dasharray"},jr={offset:"strokeDashoffset",array:"strokeDasharray"};const Gr=["offsetDistance","offsetPath","offsetRotate","offsetAnchor"];function qr(t,{attrX:e,attrY:i,attrScale:s,pathLength:r,pathSpacing:a=1,pathOffset:n=0,...o},l,d,c){if(Ar(t,o,d),l)return void(t.style.viewBox&&(t.attrs.viewBox=t.style.viewBox));t.attrs=t.style,t.style={};const{attrs:p,style:h}=t;p.transform&&(h.transform=p.transform,delete p.transform),(h.transform||p.transformOrigin)&&(h.transformOrigin=p.transformOrigin??"50% 50%",delete p.transformOrigin),h.transform&&(h.transformBox=c?.transformBox??"fill-box",delete p.transformBox);for(const t of Gr)void 0!==p[t]&&(h[t]=p[t],delete p[t]);void 0!==e&&(p.x=e),void 0!==i&&(p.y=i),void 0!==s&&(p.scale=s),void 0!==r&&function(t,e,i=1,s=0,r=!0){t.pathLength=1;const a=r?Vr:jr;t[a.offset]=""+-s,t[a.array]=`${e} ${i}`}(p,r,a,n,!1)}const Ur=new Set(["baseFrequency","diffuseConstant","kernelMatrix","kernelUnitLength","keySplines","keyTimes","limitingConeAngle","markerHeight","markerWidth","numOctaves","targetX","targetY","surfaceScale","specularConstant","specularExponent","stdDeviation","tableValues","viewBox","gradientTransform","pathLength","startOffset","textLength","lengthAdjust"]);class Wr extends Cr{constructor(){super(...arguments),this.type="svg",this.isSVGTag=!1,this.measureInstanceViewportBox=br}getBaseTargetFromProps(t,e){return t[e]}readValueFromInstance(t,e){if(Gi.has(e)){const t=dr(e);return t&&t.default||0}return e=Ur.has(e)?e:Ws(e),t.getAttribute(e)}scrapeMotionValuesFromProps(t,e,i){return function(t,e,i){const s=Nr(t,e,i);for(const i in t)(qs(t[i])||qs(e[i]))&&(s[-1!==ji.indexOf(i)?"attr"+i.charAt(0).toUpperCase()+i.substring(1):i]=t[i]);return s}(t,e,i)}build(t,e,i){qr(t,e,this.isSVGTag,i.transformTemplate,i.style)}renderInstance(t,e,i,s){!function(t,e,i,s){zr(t,e,void 0,s);for(const i in e.attrs)t.setAttribute(Ur.has(i)?i:Ws(i),e.attrs[i])}(t,e,0,s)}mount(t){var e;this.isSVGTag="string"==typeof(e=t.tagName)&&"svg"===e.toLowerCase(),super.mount(t)}}function Hr(t){return"object"==typeof t&&!Array.isArray(t)}function Yr(t,e,i,s){return null==t?[]:"string"==typeof t&&Hr(e)?function(t,e,i){if(null==t)return[];if(t instanceof EventTarget)return[t];if("string"==typeof t){let s=document;e&&(s=e.current);const r=i?.[t]??s.querySelectorAll(t);return r?Array.from(r):[]}return Array.from(t).filter(t=>null!=t)}(t,i,s):t instanceof NodeList?Array.from(t):Array.isArray(t)?t.filter(t=>null!=t):[t]}function Xr(t,e,i){return t*(e+1)}function Kr(t,e,i,s){return"number"==typeof e?e:e.startsWith("-")||e.startsWith("+")?Math.max(0,t+parseFloat(e)):"<"===e?i:e.startsWith("<")?Math.max(0,i+parseFloat(e.slice(1))):s.get(e)??t}function Jr(t,e,i,s,r,a){!function(t,e,i){for(let s=0;s<t.length;s++){const r=t[s];r.at>e&&r.at<i&&(ct(t,r),s--)}}(t,r,a);for(let n=0;n<e.length;n++)t.push({value:e[n],at:De(r,a,s[n]),easing:jt(i,n)})}function Zr(t,e){for(let i=0;i<t.length;i++)t[i]=t[i]/(e+1)}function Qr(t,e){return t.at===e.at?null===t.value?1:null===e.value?-1:0:t.at-e.at}function ta(t,e){return!e.has(t)&&e.set(t,{}),e.get(t)}function ea(t,e){return e[t]||(e[t]=[]),e[t]}function ia(t){return Array.isArray(t)?t:[t]}function sa(t,e){return t&&t[e]?{...t,...t[e]}:{...t}}const ra=t=>"number"==typeof t,aa=t=>t.every(ra);function na(t){const e={presenceContext:null,props:{},visualState:{renderState:{transform:{},transformOrigin:{},style:{},vars:{},attrs:{}},latestValues:{}}},i=vr(t)&&!function(t){return vr(t)&&"svg"===t.tagName}(t)?new Wr(e):new Br(e);i.mount(t),xr.set(t,i)}function oa(t){const e=new Rr({presenceContext:null,props:{},visualState:{renderState:{output:{}},latestValues:{}}});e.mount(t),xr.set(t,e)}function la(t,e,i,s){const r=[];if(function(t,e){return qs(t)||"number"==typeof t||"string"==typeof t&&!Hr(e)}(t,e))r.push(function(t,e,i){const s=qs(t)?t:Rs(t);return s.start(Is("",s,e,i)),s.animation}(t,Hr(e)&&e.default||e,i&&i.default||i));else{if(null==t)return r;const a=Yr(t,e,s),n=a.length;gt(Boolean(n),"No valid elements provided.","no-valid-elements");for(let t=0;t<n;t++){const s=a[t],o=s instanceof Element?na:oa;xr.has(s)||o(s);const l=xr.get(s),d={...i};"delay"in d&&"function"==typeof d.delay&&(d.delay=d.delay(t,n)),r.push(...Ks(l,{...e,transition:d},{}))}}return r}function da(t,e,i){const s=[],r=function(t,{defaultTransition:e={},...i}={},s,r){const a=e.duration||.3,n=new Map,o=new Map,l={},d=new Map;let c=0,p=0,h=0;for(let i=0;i<t.length;i++){const n=t[i];if("string"==typeof n){d.set(n,p);continue}if(!Array.isArray(n)){d.set(n.name,Kr(p,n.at,c,d));continue}let[u,g,m={}]=n;void 0!==m.at&&(p=Kr(p,m.at,c,d));let v=0;const f=(t,i,s,n=0,o=0)=>{const l=ia(t),{delay:d=0,times:c=$i(l),type:u=e.type||"keyframes",repeat:g,repeatType:m,repeatDelay:f=0,...b}=i;let{ease:x=e.ease||"easeOut",duration:y}=i;const _="function"==typeof d?d(n,o):d,w=l.length,$=cs(u)?u:r?.[u||"keyframes"];if(w<=2&&$){let t=100;if(2===w&&aa(l)){const e=l[1]-l[0];t=Math.abs(e)}const i={...e,...b};void 0!==y&&(i.duration=kt(y));const s=Ze(i,t,$);x=s.ease,y=s.duration}y??(y=a);const k=p+_;1===c.length&&0===c[0]&&(c[1]=1);const S=c.length-l.length;if(S>0&&wi(c,S),1===l.length&&l.unshift(null),g){gt(g<20,"Repeat count too high, must be less than 20","repeat-count-high"),y=Xr(y,g);const t=[...l],e=[...c];x=Array.isArray(x)?[...x]:[x];const i=[...x];for(let s=0;s<g;s++){l.push(...t);for(let r=0;r<t.length;r++)c.push(e[r]+(s+1)),x.push(0===r?"linear":jt(i,r-1))}Zr(c,g)}const M=k+y;Jr(s,l,x,c,k,M),v=Math.max(_+y,v),h=Math.max(M,h)};if(qs(u))f(g,m,ea("default",ta(u,o)));else{const t=Yr(u,g,s,l),e=t.length;for(let i=0;i<e;i++){const s=ta(t[i],o);for(const t in g)f(g[t],sa(m,t),ea(t,s),i,e)}}c=p,p+=v}return o.forEach((t,s)=>{for(const r in t){const a=t[r];a.sort(Qr);const o=[],l=[],d=[];for(let t=0;t<a.length;t++){const{at:e,value:i,easing:s}=a[t];o.push(i),l.push(wt(0,h,e)),d.push(s||"easeOut")}0!==l[0]&&(l.unshift(0),o.unshift(o[0]),d.unshift("easeInOut")),1!==l[l.length-1]&&(l.push(1),o.push(null)),n.has(s)||n.set(s,{keyframes:{},transition:{}});const c=n.get(s);c.keyframes[r]=o;const{type:p,...u}=e;c.transition[r]={...u,duration:h,ease:d,times:l,...i}}}),n}(t.map(t=>{if(Array.isArray(t)&&"function"==typeof t[0]){const e=t[0],i=Rs(0);return i.on("change",e),1===t.length?[i,[0,1]]:2===t.length?[i,[0,1],t[1]]:[i,t[1],t[2]]}return t}),e,i,{spring:bi});return r.forEach(({keyframes:t,transition:e},i)=>{s.push(...la(i,t,e))}),s}const ca=function(t={}){const{scope:e,reduceMotion:i}=t;return function(t,s,r){let a,n=[];if(o=t,Array.isArray(o)&&o.some(Array.isArray)){const{onComplete:r,...o}=s||{};"function"==typeof r&&(a=r),n=da(t,void 0!==i?{reduceMotion:i,...o}:o,e)}else{const{onComplete:o,...l}=r||{};"function"==typeof o&&(a=o),n=la(t,s,void 0!==i?{reduceMotion:i,...l}:l,e)}var o;const l=new Ss(n);return a&&l.finished.then(a),e&&(e.animations.push(l),l.finished.then(()=>{ct(e.animations,l)})),l}}();class pa{constructor(t){this.host=t,t.addController(this),this.dragging=!1,this.itemId=null,this.w=1,this.h=1,this.previewCol=0,this.previewRow=0,this._tileEl=null,this._ghostEl=null,this._offsetX=0,this._offsetY=0,this._gridRect=null,this._gridPadLeft=16,this._gridPadTop=12,this._scrollEl=null,this._scrollRAF=null,this._pointerId=null,this._pending=!1,this._startX=0,this._startY=0,this._dragThreshold=8,this._onPointerMove=this._onPointerMove.bind(this),this._onPointerUp=this._onPointerUp.bind(this)}hostConnected(){}hostDisconnected(){this._cleanup()}start(t){if(t.target.closest("button, input, select, .resize-btn"))return!1;const e=t.target.closest(".grid-tile");if(!e)return!1;const i=e.dataset.tileId;if(!i)return!1;t.preventDefault();const s=this.host.shadowRoot.querySelector(".unified-grid");if(!s)return!1;const r=e.getBoundingClientRect();return this._pending=!0,this._startX=t.clientX,this._startY=t.clientY,this.itemId=i,this.w=parseInt(e.dataset.tileW,10)||1,this.h=parseInt(e.dataset.tileH,10)||1,this._tileEl=e,this._scrollEl=s,this._pointerId=t.pointerId,this._offsetX=t.clientX-r.left,this._offsetY=t.clientY-r.top,s.setPointerCapture(t.pointerId),s.addEventListener("pointermove",this._onPointerMove),s.addEventListener("pointerup",this._onPointerUp),s.addEventListener("pointercancel",this._onPointerUp),!0}_beginDrag(){this._pending=!1,this.dragging=!0;const t=this._scrollEl,e=this._tileEl;if(!t||!e)return;const i=e.getBoundingClientRect();this._gridRect=t.getBoundingClientRect(),this.previewCol=parseInt(e.dataset.tileCol,10)||0,this.previewRow=parseInt(e.dataset.tileRow,10)||0,this._createGhost(e,i),e.style.opacity="0",e.style.pointerEvents="none",this.host.requestUpdate()}_onPointerMove(t){if(this._pending){const e=t.clientX-this._startX,i=t.clientY-this._startY;if(!(Math.sqrt(e*e+i*i)>=this._dragThreshold))return;this._beginDrag()}if(!this.dragging)return;this._ghostEl&&(this._ghostEl.style.left=t.clientX-this._offsetX+"px",this._ghostEl.style.top=t.clientY-this._offsetY+"px");const e=this.host._gridCellW||80,i=this.host._gridGap||12,s=this._scrollEl,r=s?.scrollTop||0,a=s?.getBoundingClientRect()??this._gridRect,n=t.clientX-this._offsetX,o=t.clientY-this._offsetY,l=n-a.left-this._gridPadLeft,d=o-a.top-this._gridPadTop+r,c=Math.max(0,Math.min(this.host._gridCols-this.w,Math.round(l/(e+i)))),p=Math.max(0,Math.round(d/(e+i)));c===this.previewCol&&p===this.previewRow||(this.previewCol=c,this.previewRow=p,this.host.onTileDragMove(this.itemId,c,p)),this._autoScroll(t)}_onPointerUp(t){if(this._pending)return this._pending=!1,this.host.onTileTap&&this.host.onTileTap(this.itemId),void this._cleanup();this.dragging&&(this.host.onTileDragEnd(this.itemId,this.previewCol,this.previewRow),this._cleanup(),this.host.requestUpdate())}_createGhost(t,e){const i=t.cloneNode(!0);i.classList.add("drag-ghost"),i.style.cssText=`\n      position: fixed;\n      left: ${e.left}px;\n      top: ${e.top}px;\n      width: ${e.width}px;\n      height: ${e.height}px;\n      z-index: 10000;\n      opacity: 0.85;\n      pointer-events: none;\n      box-shadow: 0 8px 30px rgba(0,0,0,0.5);\n      border-radius: 16px;\n      transition: none;\n      animation: none;\n    `,this.host.shadowRoot.appendChild(i),this._ghostEl=i}_autoScroll(t){this._scrollRAF&&cancelAnimationFrame(this._scrollRAF);const e=this._scrollEl;if(!e)return;const i=e.getBoundingClientRect(),s=40;let r=0;if(t.clientY>i.bottom-s?r=(t.clientY-(i.bottom-s))/s*10:t.clientY<i.top+s&&(r=(i.top+s-t.clientY)/s*-10),Math.abs(r)>.5){const t=()=>{e.scrollTop+=r,this._gridRect=e.getBoundingClientRect(),this.dragging&&(this._scrollRAF=requestAnimationFrame(t))};this._scrollRAF=requestAnimationFrame(t)}}_cleanup(){this._pending=!1,this._scrollRAF&&(cancelAnimationFrame(this._scrollRAF),this._scrollRAF=null),this._ghostEl&&(this._ghostEl.remove(),this._ghostEl=null),this._tileEl&&(this._tileEl.style.opacity="",this._tileEl.style.pointerEvents="",this._tileEl=null);const t=this.host.shadowRoot?.querySelector(".unified-grid");if(t&&null!=this._pointerId){try{t.releasePointerCapture(this._pointerId)}catch(t){}t.removeEventListener("pointermove",this._onPointerMove),t.removeEventListener("pointerup",this._onPointerUp),t.removeEventListener("pointercancel",this._onPointerUp)}this.dragging=!1,this.itemId=null,this._pointerId=null}}function ha(t,e){const i=[];for(const[s,r]of Object.entries(t))for(let t=r.row;t<r.row+r.h;t++){i[t]||(i[t]=new Array(e).fill(null));for(let a=r.col;a<r.col+r.w;a++)a<e&&(i[t][a]=s)}return i}function ua(t,e,i,s,r,a){if(e+s>a||e<0)return!1;for(let a=i;a<i+r;a++)for(let i=e;i<e+s;i++)if(null!=t[a]?.[i])return!1;return!0}function ga(t,e,i,s,r,a,n){for(let o=i;o<i+r;o++){t[o]||(t[o]=new Array(n).fill(null));for(let i=e;i<e+s;i++)i<n&&(t[o][i]=a)}}function ma(t,e,i,s){for(let r=0;r<200;r++)for(let a=0;a<=e-i;a++)if(ua(t,a,r,i,s,e))return{col:a,row:r};return{col:0,row:0}}function va(t,e,i){const s={},r=[];for(const a of t){if("spacer"===a.type)continue;const{w:t,h:n}=i(a),o=ma(r,e,t,n);s[a.id]={col:o.col,row:o.row,w:t,h:n},ga(r,o.col,o.row,t,n,a.id,e)}return s}function fa(t,e){return!(t.col+t.w<=e.col||e.col+e.w<=t.col||t.row+t.h<=e.row||e.row+e.h<=t.row)}function ba(t,e){const i=t[e],s=[];for(const[r,a]of Object.entries(t))r!==e&&fa(i,a)&&s.push(r);return s}function xa(t,e,i,s,r){const a={};for(const[e,i]of Object.entries(t))a[e]={...i};const n=a[e];if(!n)return a;i=Math.max(0,Math.min(r-n.w,i)),s=Math.max(0,s),n.col=i,n.row=s;for(let t=0;t<50;t++){const i=ba(a,e);if(0===i.length)break;for(const e of i){const i=a[e],s=n.col+n.w;if(s+i.w<=r){const t={col:i.col,row:i.row};i.col=s;if(0===ba(a,e).length)continue;i.col=t.col,i.row=t.row}const o=n.col-i.w;if(o>=0){const t={col:i.col,row:i.row};i.col=o;if(0===ba(a,e).length)continue;i.col=t.col,i.row=t.row}i.row=n.row+n.h,ya(a,e,50-t)}}return a}function ya(t,e,i){for(let s=0;s<i;s++){const i=ba(t,e);if(0===i.length)return;let s=0;for(const e of i){const i=t[e];s=Math.max(s,i.row+i.h)}t[e].row=s}}function _a(t,e,i,s){const r={},a=[],n=new Map(e.filter(t=>"spacer"!==t.type).map(t=>[t.id,t]));for(const e of t){if(null==e)continue;const t=n.get(e);if(!t)continue;const{w:o,h:l}=s(t),d=ma(a,i,o,l);r[e]={col:d.col,row:d.row,w:o,h:l},ga(a,d.col,d.row,o,l,e,i),n.delete(e)}for(const[t,e]of n){const{w:n,h:o}=s(e),l=ma(a,i,n,o);r[t]={col:l.col,row:l.row,w:n,h:o},ga(a,l.col,l.row,n,o,t,i)}return r}const wa=[{name:"Warm",r:255,g:180,b:107},{name:"Cool",r:200,g:220,b:255},{name:"White",r:255,g:255,b:255},{name:"Red",r:255,g:50,b:50},{name:"Blue",r:50,g:100,b:255},{name:"Green",r:50,g:200,b:80}],$a=[{keyword:"water",label:"Water",icon:"mdi:water",color:"#2196F3",warnBelow:25},{keyword:"gas",label:"Gas",icon:"mdi:gas-cylinder",color:"#FF9800",warnBelow:20},{keyword:"waste",label:"Waste",icon:"mdi:delete-empty",color:"#78909C",warnAbove:75}];function ka(t,e,i){return"#"+[t,e,i].map(t=>t.toString(16).padStart(2,"0")).join("")}const Sa=a`
  .toggle {
    width: 44px;
    height: 26px;
    border-radius: 13px;
      ...
      <div class="picker">
        ...
        ${this._open?j`
          <div class="dropdown">
            ...
            <div class="list">
              ${this.pinnedEntity&&this.hass?.states?.[this.pinnedEntity]?(()=>{const t=this.hass.states[this.pinnedEntity],e=t.attributes?.friendly_name??this.pinnedEntity.split(".").pop().replace(/_/g," "),i=t.attributes?.icon||this._domainIcon(this.pinnedEntity);return j`
                  <div class="option pinned ${this.pinnedEntity===this.value?"active":""}"
                       @click=${()=>this._select(this.pinnedEntity)}>
                    <ha-icon class="opt-icon" icon="${i}" style="--mdc-icon-size:18px"></ha-icon>
                    <div class="opt-info">
                      <span class="opt-name">${e}</span>
                ...
                `})():""}
              ${this._filtered().filter(t=>t.eid!==this.pinnedEntity).map(t=>j`
                <div class="option ${t.eid===this.value?"active":""}"
                     @click=${()=>this._select(t.eid)}>
                  <ha-icon class="opt-icon" icon="${t.icon}" style="--mdc-icon-size:18px"></ha-icon>
                  <div class="opt-info">
              ...
              `)}
              ${0!==this._filtered().filter(t=>t.eid!==this.pinnedEntity).length||this.pinnedEntity?"":j`
...
const Ta=(t,e)=>{const i=t._$AN;if(void 0===i)return!1;for(const t of i)t._$AO?.(e,!1),Ta(t,e);return!0},Ca=t=>{let e,i;do{if(void 0===(e=t._$AM))break;i=e._$AN,i.delete(t),t=e}while(0===i?.size)},Ea=t=>{for(let e;e=t._$AM;t=e){let i=e._$AN;if(void 0===i)e._$AN=i=new Set;else if(i.has(t))break;i.add(t),za(e)}};function Pa(t){void 0!==this._$AN?(Ca(this),this._$AM=t,Ea(this)):this._$AM=t}function Aa(t,e=!1,i=0){const s=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(e)if(Array.isArray(s))for(let t=i;t<s.length;t++)Ta(s[t],!1),Ca(s[t]);else null!=s&&(Ta(s,!1),Ca(s));else Ta(this,t)}const za=t=>{t.type==lt&&(t._$AP??=Aa,t._$AQ??=Pa)};class La extends dt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),Ea(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(Ta(this,t),Ca(this))}setValue(t){if((t=>void 0===t.strings)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}const Oa=new WeakMap,Ia=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends La{render(t){return q}update(t,[e]){const i=e!==this.G;return i&&void 0!==this.G&&this.rt(void 0),(i||this.lt!==this.ct)&&(this.G=e,this.ht=t.options?.host,this.rt(this.ct=t.element)),q}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.G){const e=this.ht??globalThis;let i=Oa.get(e);void 0===i&&(i=new WeakMap,Oa.set(e,i)),void 0!==i.get(this.G)&&this.G.call(this.ht,void 0),i.set(this.G,t),void 0!==t&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){return"function"==typeof this.G?Oa.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});customElements.define("smartvanio-modal-edit",class extends nt{static get properties(){return{hass:{type:Object},entityId:{type:String,attribute:"entity-id"},deviceId:{type:String,attribute:"device-id"},editName:{type:String,attribute:"edit-name"},editArea:{type:String,attribute:"edit-area"},_areaPickerOpen:{type:Boolean,state:!0},_areaFilter:{type:String,state:!0},_selectedSegIdx:{type:Number,state:!0},_ledTab:{type:String,state:!0},_rightTab:{type:String,state:!0},_modalView:{type:String,state:!0},lightPatterns:{type:Object},entityPatterns:{type:Object},activePattern:{type:String,attribute:"active-pattern"},_patternStops:{type:Array,state:!0},_editingPatternName:{type:String,state:!0},_selectedStopIdx:{type:Number,state:!0},editRows:{type:Array},editSaving:{type:Boolean,attribute:"edit-saving"},editLoading:{type:Boolean,attribute:"edit-loading"},calPoints:{type:Array},calKind:{type:String,attribute:"cal-kind"},lightSegments:{type:Array},maxLeds:{type:Number,attribute:"max-leds"},expandedSegColor:{type:String,attribute:"expanded-seg-color"},saveError:{type:String,attribute:"save-error"},isButton:{type:Boolean,attribute:"is-button"},isSwitch:{type:Boolean,attribute:"is-switch"},isTank:{type:Boolean,attribute:"is-tank"},isLight:{type:Boolean,attribute:"is-light"},targetEntities:{type:Array},sourceEntities:{type:Array}}}constructor(){super(),this.editRows=[],this.lightSegments=[],this.lightPatterns={},this.entityPatterns={},this.activePattern=null,this._patternStops=null,this._editingPatternName="",this._selectedStopIdx=null,this._ledTab="segments",this._rightTab=null,this._modalView=null,this.maxLeds=0,this.calPoints=null,this.calKind="linear",this.targetEntities=[],this.sourceEntities=[],this._presetColors=[[255,180,107],[255,100,100],[100,200,255],[100,255,130]]}updated(t){super.updated(t),t.has("entityId")&&void 0!==t.get("entityId")&&(this._modalView=null,this._wheelDrawn=!1)}_rgbToWheelPos(t,e){if(!t)return null;const[i,s,r]=t.map(t=>t/255),a=Math.max(i,s,r),n=a-Math.min(i,s,r);if(0===a)return null;let o;o=0===n?0:a===i?((s-r)/n+6)%6*60:a===s?60*((r-i)/n+2):60*((i-s)/n+4);const l=n/a,d=e/2,c=d-4,p=o*Math.PI/180,h=l*c;return{x:d+Math.cos(p)*h,y:d+Math.sin(p)*h}}_onWheelRef(t){t&&!t._wheelDrawn&&(this._drawColorWheel(t),t._wheelDrawn=!0)}_drawColorWheel(t){if(!t)return;const e=t.getContext("2d"),i=t.width/2,s=t.height/2,r=i-4;e.clearRect(0,0,t.width,t.height);for(let t=0;t<360;t+=1){const a=(t-1)*Math.PI/180,n=(t+1)*Math.PI/180,o=e.createRadialGradient(i,s,0,i,s,r),[l,d,c]=this._hsvToRgb(t,1,1);o.addColorStop(0,"#fff"),o.addColorStop(1,`rgb(${l},${d},${c})`),e.beginPath(),e.moveTo(i,s),e.arc(i,s,r,a,n),e.closePath(),e.fillStyle=o,e.fill()}}_hsvToRgb(t,e,i){const s=i*e,r=s*(1-Math.abs(t/60%2-1)),a=i-s;let n,o,l;return t<60?(n=s,o=r,l=0):t<120?(n=r,o=s,l=0):t<180?(n=0,o=s,l=r):t<240?(n=0,o=r,l=s):t<300?(n=r,o=0,l=s):(n=s,o=0,l=r),[Math.round(255*(n+a)),Math.round(255*(o+a)),Math.round(255*(l+a))]}_ctrlBriPick(t,e){if(e&&(t.target.setPointerCapture(t.pointerId),this._briDragging=!0),!t.buttons&&!e)return;t.stopPropagation();const i=t.currentTarget.getBoundingClientRect(),s=Math.max(20,Math.min(t.clientX-i.left,i.width-20)),r=Math.round((s-20)/(i.width-40)*100);this._localBri=r,this.requestUpdate();const a=Date.now();(!this._lastBriEmit||a-this._lastBriEmit>80)&&(this._lastBriEmit=a,this._emit("smartvanio-light-brightness",{brightness:r}))}_ctrlBriRelease(t){t.target.releasePointerCapture(t.pointerId),this._briDragging=!1,null!=this._localBri&&this._emit("smartvanio-light-brightness",{brightness:this._localBri}),setTimeout(()=>{this._localBri=null,this.requestUpdate()},500)}_ctrlColorPick(t,e){if(e&&(t.target.setPointerCapture(t.pointerId),this._colorDragging=!0),!t.buttons&&!e)return;t.stopPropagation();const i=t.currentTarget,s=i.getBoundingClientRect(),r=i.width/s.width,a=i.width/2,n=i.height/2,o=a-4,l=(t.clientX-s.left)*r-a,d=(t.clientY-s.top)*r-n,c=Math.sqrt(l*l+d*d);if(c>o+8)return;const p=(180*Math.atan2(d,l)/Math.PI+360)%360,h=Math.min(c/o,1),[u,g,m]=this._hsvToRgb(p,h,1);this._localRgb=[u,g,m],this.requestUpdate();const v=Date.now();(!this._lastColorEmit||v-this._lastColorEmit>80)&&(this._lastColorEmit=v,this._emit("smartvanio-light-color",{rgb:[u,g,m]}))}_ctrlColorRelease(t){t.target.releasePointerCapture(t.pointerId),this._colorDragging=!1,this._localRgb&&this._emit("smartvanio-light-color",{rgb:[...this._localRgb]}),setTimeout(()=>{this._localRgb=null,this.requestUpdate()},500)}_patternGradientCSS(t){if(!t?.length)return"";const e=[...t].sort((t,e)=>t.pos-e.pos),i=e[e.length-1].pos||1,s=e.map(t=>{const e=(t.brightness??100)/100;return`rgb(${Math.round(t.r*e)},${Math.round(t.g*e)},${Math.round(t.b*e)}) ${(t.pos/i*100).toFixed(1)}%`});return`linear-gradient(to right, ${s.join(", ")})`}_renderControlView(){const t=this.entityId,e=this.hass?.states?.[t],i="on"===e?.state,s=e?.attributes??{},r=null!=s.brightness?Math.round(s.brightness/255*100):i?100:0,a=this._localBri??r,n=s.rgb_color,o=(s.supported_color_modes??[]).some(t=>["rgb","hs","xy","rgbw","rgbww"].includes(t)),l=this.entityPatterns??{},d=Object.keys(l);let c=null;this.activePattern?.startsWith(t+":")&&(c=this.activePattern.slice(t.length+1));const p=c?l[c]:null,h=p?this._patternGradientCSS(p):null,u=this._localRgb||n,g=u?`rgb(${u.join(",")})`:"var(--primary-color)";return j`
            ...
            <div class="area-picker-list">
              ...
              ${r.map(t=>j`
                <div class="area-picker-item ${t.name===e?"selected":""}"
                  ...
                  <ha-icon icon="${t.icon||"mdi:map-marker"}" style="--mdc-icon-size:16px"></ha-icon>
                  <span>${t.name}</span>
                </div>
              `)}
        ...
        <div class="strip-wrap">
          <div class="strip-bar"
            ...
            ${t.map((s,r)=>{const a=s.start/e*100,n=(s.end-s.start+1)/e*100;return j`
                <div class="strip-seg ${i===r?"selected":""}"
                  style="left:${a}%;width:${n}%;background:rgba(${s.r},${s.g},${s.b},${(s.brightness??100)/100})"
                  @click=${t=>{t.stopPropagation(),this._selectedSegIdx=r,this.requestUpdate()}}>
          ...
          <div class="seg-detail">
            <div class="seg-detail-row">
              <input type="color" class="seg-color-input"
                .value=${ka(s.r,s.g,s.b)}
                @input=${t=>this._emitSegUpdate(i,"color",t.target.value)} />
            ...
            <div class="seg-detail-row">
              <div class="seg-field">
                ...
                <input type="number" class="cal-input" min="0" .value=${String(s.start??0)}
                  @change=${t=>this._emitSegUpdate(i,"start",Math.max(0,+t.target.value))} />
              </div>
              <div class="seg-field">
                <span class="seg-field-label">End</span>
                <input type="number" class="cal-input" min="0" .value=${String(s.end??0)}
                  @change=${t=>this._emitSegUpdate(i,"end",Math.max(0,+t.target.value))} />
              </div>
              <div class="seg-field">
                <span class="seg-field-label">Brightness</span>
                <input type="number" class="cal-input" min="1" max="100" .value=${String(s.brightness??100)}
                  @change=${t=>this._emitSegUpdate(i,"brightness",Math.max(1,Math.min(100,+t.target.value)))} />
          ...
          <div class="seg-list">
            ${t.map((t,e)=>j`
              <div class="seg-list-item ${i===e?"active":""}" @click=${()=>{this._selectedSegIdx=e,this.requestUpdate()}}>
                ...
                <span class="seg-list-bri">${t.brightness??100}%</span>
      ...
      <div class="modal-section">
        ...
        <div class="pattern-editor">
          <div class="pattern-bar-wrap">
            <div class="pattern-bar" style="background:${this._gradientCSS(t)}"
              @click=${e=>this._onPatternStripClick(e,t)}>
            </div>
            <div class="pattern-stops-track"
              @click=${e=>this._onPatternStripClick(e,t)}>
              ${t.map((s,r)=>j`
                  <div class="pattern-stop ${i===r?"selected":""}"
                    style="left:${e>0?s.pos/e*100:0}%"
                    @click=${t=>{t.stopPropagation(),this._selectedStopIdx=r,this.requestUpdate()}}
                    @pointerdown=${e=>this._onStopDrag(e,r,t)}>
                    <div class="stop-arrow" style="border-bottom-color:rgb(${s.r},${s.g},${s.b})"></div>
                    <div class="stop-swatch" style="background:rgb(${s.r},${s.g},${s.b})"></div>
                  </div>
                `)}
            </div>
          </div>
        ...
        <div class="pattern-stop-list">
          ${o.map(s=>{const r=s._idx;return j`
              <div class="pattern-stop-row ${i===r?"selected":""}"
                @click=${()=>{this._selectedStopIdx=r,this.requestUpdate()}}>
                <input type="color" class="pattern-stop-color"
                  .value=${ka(s.r,s.g,s.b)}
                  @input=${t=>this._updateStop(r,"color",t.target.value)}
                  @click=${t=>t.stopPropagation()} />
                <input type="number" class="pattern-stop-pos" min="0" max="${e}"
                  .value=${String(s.pos)}
                  @change=${t=>{t.stopPropagation(),this._updateStop(r,"pos",Math.max(0,Math.min(e,+t.target.value)))}}
                  @click=${t=>t.stopPropagation()} />
                <input type="range" class="pattern-stop-bri" min="0" max="100"
                  .value=${String(s.brightness??100)}
                  @input=${t=>{t.stopPropagation(),this._updateStop(r,"brightness",+t.target.value)}}
                  @click=${t=>t.stopPropagation()} />
                <span class="pattern-stop-bri-label">${s.brightness??100}%</span>
                <button class="pattern-stop-del" ?disabled=${t.length<=2} @click=${e=>{e.stopPropagation(),t.length<=2||(this._patternStops=t.filter((t,e)=>e!==r),i===r?this._selectedStopIdx=null:i>r&&(this._selectedStopIdx=i-1),this._emit("smartvanio-pattern-preview",{stops:this._patternStops}),this.requestUpdate())}}>
                  <ha-icon icon="mdi:close" style="--mdc-icon-size:14px"></ha-icon>
                </button>
              </div>
            `})}
        ...
        <div class="pattern-save-row">
          ...
          <button class="modal-btn save pattern-save-btn"
            ?disabled=${!this._editingPatternName?.trim()||t.length<2}
            @click=${()=>{const e=this._editingPatternName?.trim();!e||t.length<2||(this._emit("smartvanio-save-pattern",{name:e,stops:t}),this._editingPatternName="")}}>Save</button>
        </div>
        ...
        ${r.length?j`
          <div class="seg-list">
            ${r.map(t=>j`
              <div class="seg-list-item ${t===n?"active":""}" @click=${()=>{this._patternStops=[...s[t]],this._editingPatternName=t,this._selectedStopIdx=null,this._emit("smartvanio-pattern-preview",{stops:s[t]}),this.requestUpdate()}}>
                <span class="seg-list-swatch" style="background:${this._gradientCSS(s[t])};width:40px"></span>
                <span class="seg-list-name">${t}</span>
                <button class="seg-list-del" @click=${e=>{e.stopPropagation(),this._emit("smartvanio-delete-pattern",{name:t})}}>
                  <ha-icon icon="mdi:close" style="--mdc-icon-size:14px"></ha-icon>
                </button>
              </div>
            `)}
    ...
    `}_onPatternStripClick(t,e){const i=(t.target.closest(".pattern-bar-wrap")||t.currentTarget).getBoundingClientRect(),s=t.clientX-i.left,r=this._maxPos,a=Math.round(s/i.width*r),n=[...e].sort((t,e)=>t.pos-e.pos);let o=255,l=255,d=255;if(n.length>=2){let t=n[0],e=n[n.length-1];for(let i=0;i<n.length-1;i++)if(a>=n[i].pos&&a<=n[i+1].pos){t=n[i],e=n[i+1];break}const i=e.pos-t.pos,s=i>0?(a-t.pos)/i:0;o=Math.round(t.r+s*(e.r-t.r)),l=Math.round(t.g+s*(e.g-t.g)),d=Math.round(t.b+s*(e.b-t.b))}const c=[...e,{pos:a,r:o,g:l,b:d,brightness:100}];this._patternStops=c,this._selectedStopIdx=c.length-1,this._emit("smartvanio-pattern-preview",{stops:c}),this.requestUpdate()}_onStopDrag(t,e,i){t.stopPropagation(),t.preventDefault();const s=t.target.closest(".pattern-bar-wrap").getBoundingClientRect();this._selectedStopIdx=e;const r=this._maxPos,a=t=>{const i=t.clientX-s.left;let a=Math.round(i/s.width*r);a=Math.max(0,Math.min(r,a));const n=[...this._patternStops];n[e]={...n[e],pos:a},this._patternStops=n,this._emit("smartvanio-pattern-preview",{stops:n}),this.requestUpdate()},n=()=>{document.removeEventListener("pointermove",a),document.removeEventListener("pointerup",n)};document.addEventListener("pointermove",a),document.addEventListener("pointerup",n)}_updateStop(t,e,i){const s=[...this._patternStops??[]];if(s[t]){if("color"===e){const e=i.replace("#","");s[t]={...s[t],r:parseInt(e.substring(0,2),16),g:parseInt(e.substring(2,4),16),b:parseInt(e.substring(4,6),16)}}else s[t]={...s[t],[e]:i};this._patternStops=s,this._emit("smartvanio-pattern-preview",{stops:s}),this.requestUpdate()}}_renderAutomationsSection(){return j`
      <div class="modal-section">
        <div class="modal-section-header">
    ...
    `}render(){if(!this.entityId)return j``;const t=this.entityId,e=this.hass?.entities?.[t]?.name||this.hass?.states[t]?.attributes?.friendly_name||t.split(".").pop(),i=this.hass?.entities?.[t]?.device_id,s=i?this.hass?.devices?.[i]:null,r=s?.name_by_user??s?.name??null,a=this._modalView??(this.isLight?"control":"settings");return j`
      <div
        class="modal-overlay"
        @click=${t=>{t.target===t.currentTarget&&this._emit("smartvanio-modal-close")}}
      >
        <div class="modal ${"control"===a?"modal-control":""}">
          <div class="modal-header">
            ${"settings"===a&&this.isLight?j`
              <button class="modal-header-btn" @click=${()=>{this._modalView="control"}}>
                <ha-icon icon="mdi:arrow-left" style="--mdc-icon-size:20px"></ha-icon>
              </button>
            `:""}
            <span>${"control"===a?e:`Edit ${e}`}${r?j`<span class="modal-header-device">${r}</span>`:""}</span>
            <div class="modal-header-actions">
              ${"control"===a&&this.isLight?j`
        ...
        <div class="modal">
          ...
          <div class="modal-body">
            ...
            <div class="modal-section">
              ...
              ${(this.sceneEditLights??[]).map(t=>{const e="ON"===(t.state??"ON").toUpperCase(),[i,s,r]=t.rgb_color??[255,255,255],a=Math.round((t.brightness??255)/255*100),n=this.hass?.states[t.entity_id],o=n?.attributes?.supported_color_modes?.includes("rgb")??!1,l=n?.attributes?.effect_list??[],d=l.length>0,c=t.effect??"",p=ka(i,s,r),h=e?`rgb(${i},${s},${r})`:"rgba(128,128,128,0.4)",u=`linear-gradient(to right, ${h} 0%, ${h} ${a}%, var(--slider-track,#e0e0e0) ${a}%, var(--slider-track,#e0e0e0) 100%)`,g=this._entityLabel(t.entity_id);return j`
    ...
    `}});customElements.define("smartvanio-tile-light",class extends nt{static get properties(){return{hass:{type:Object},entityId:{type:String,attribute:"entity-id"},editMode:{type:Boolean,attribute:"edit-mode"},deviceId:{type:String,attribute:"device-id"},_dragState:{type:Object,state:!0},_expandedSegColor:{type:String,state:!0}}}constructor(){super(),this._dragState=new Map,this._expandedSegColor=null}_lightIsOn(t){return"on"===this.hass.states[t]?.state}_lightRgb(t){return this.hass.states[t]?.attributes?.rgb_color??[255,255,255]}_lightSupRgb(t){return this.hass.states[t]?.attributes?.supported_color_modes?.includes("rgb")??!1}_lightBrightness(t){const e=this._dragState.get(t);if(e?.active)return e.brightness;const i=parseFloat(localStorage.getItem(`smartvanio_bri_${t}`));if(!isNaN(i))return i;const s=this.hass.states[t];return s?.attributes?.brightness??s?.attributes?.last_brightness??255}_persistBrightness(t,e){localStorage.setItem(`smartvanio_bri_${t}`,e)}_lightPct(t){return Math.round(this._lightBrightness(t)/255*100)}_toggleLight(t){this.hass.callService("light","toggle",{entity_id:t})}_setBrightness(t,e){this.hass.callService("light","turn_on",{entity_id:t,brightness:Math.round(e)})}_setColor(t,e,i,s){this.hass.callService("light","turn_on",{entity_id:t,rgb_color:[e,i,s]})}_onSliderInput(t,e){const i=e.target.value/100*255;this._dragState=new Map(this._dragState).set(t,{active:!0,brightness:i}),this._updateSliderFill(e.target)}_onSliderChange(t,e){const i=e.target.value/100*255;this._dragState=new Map(this._dragState).set(t,{active:!1,brightness:i}),this._persistBrightness(t,i),this._setBrightness(t,i)}_updateSliderFill(t){const e=t.value,i=t.style.getPropertyValue("--sc")||"var(--primary-color)";t.style.background=`linear-gradient(to right, ${i} 0%, ${i} ${e}%, var(--slider-track, #e0e0e0) ${e}%, var(--slider-track, #e0e0e0) 100%)`}_emitEdit(){this.dispatchEvent(new CustomEvent("smartvanio-edit-entity",{detail:{entity_id:this.entityId},bubbles:!0,composed:!0}))}_renderSegCtrlRow(t){const[e,i,s]=t.attributes.rgb_color??[255,255,255],r=this._lightBrightness(t.entity_id),a=Math.round(r/255*100),n=this.hass.entities?.[t.entity_id]?.name||t.attributes.friendly_name||"Segment",o="on"===t.state,l=this._expandedSegColor===t.entity_id,d=o?`rgb(${e},${i},${s})`:`rgba(${e},${i},${s},0.35)`;return j`
      <div class="seg-ctrl-row ${o?"on":""}">
        ...
        <input
          ...
          style="--sc:rgb(${e},${i},${s}); background:${`linear-gradient(to right, ${d} 0%, ${d} ${a}%, var(--slider-track,#e0e0e0) ${a}%, var(--slider-track,#e0e0e0) 100%)`}"
    ...
    `}render(){return this.hass&&this.entityId?"button"===this.variant?this._renderButton():this._renderDoor():j``}static get styles(){return[Sa,a`
        :host { display: block; }
      ...
      <div class="lp-panel">
        ...
        <div class="lp-list">
          ${s.map(({eid:t,state:e,_slotName:s},r)=>{const a="on"===e?.state,n=!e||"unavailable"===e.state||"unknown"===e.state,o=a?Math.round((e?.attributes?.brightness??255)/2.55):0,l=s||this._label(t),d=this._lightIcon(t),c=!!e?.attributes?.smartvanio_parent_entity_id,p=!c&&/strip/i.test(t),h=c?"Segment":p?"Strip":"";e?.attributes?.supported_color_modes?.some(t=>"rgb"===t||"hs"===t||"xy"===t);const u=e?.attributes?.rgb_color,g=i.has(t);if(this._layoutMode){const e=this._isSmartvanioLight(t);return j`
              ...
              `}const m=c?e?.attributes?.smartvanio_parent_entity_id??t:t,v=u?`rgb(${u.join(",")})`:"var(--sv-accent)",f=this._lpBriLocal?.eid===t?this._lpBriLocal.pct:o;let b=null,x=null;const y=this._getActivePatternName(t);if(y){x=this._getEntityPatterns(t)[y],x&&(b=this._patternGradientCSS(x))}const _=n?"var(--sv-red)":a&&x?.length?`rgb(${x[0].r},${x[0].g},${x[0].b})`:a&&u?`rgb(${u.join(",")})`:a?"var(--sv-accent)":"var(--sv-text-secondary)";return j`
              <div class="lp-row ${a?"on":""} ${n?"unavail":""}"
                   @pointerdown=${t=>{t.target.closest(".lp-slider-wrap")||(this._lightLpFired=!1,this._lightLpTimer=setTimeout(()=>{this._lightLpTimer=null,this._lightLpFired=!0,this._openEditModal(m)},500))}}
                ...
                <div class="lp-header" @click=${()=>{this._lightLpFired?this._lightLpFired=!1:n||this._toggleLight(t)}}>
                  <ha-icon class="lp-icon" icon="${d}"
                    style="--mdc-icon-size:20px; opacity:${n?.25:a?1:.55}; color:${_}"></ha-icon>
                  <div class="lp-info">
                    <span class="lp-name"><span class="lp-name-text">${l}</span>${h?j`<span class="lp-type">${h}</span>`:""}</span>
                    <span class="lp-bri">${n?"Unavailable":a?f+"%":"Off"}</span>
                  </div>
                ...
                ${n?"":j`
                  <div class="lp-slider-wrap" style="--lp-bri:${f}; --lp-color:${v}"
                    @pointerdown=${e=>this._lpBriPick(e,t,!0)}
                    @pointermove=${e=>this._lpBriPick(e,t,!1)}
                    @pointerup=${e=>this._lpBriRelease(e,t)}>
                    <div class="lp-slider-track"><div class="lp-slider-fill" style="${b?`background:${b}; width:100%; opacity:0.35`:""}"></div></div>
                    <div class="lp-slider-thumb" style="${b?"background:none; border-color:rgba(255,255,255,0.8)":""}"></div>
                  </div>
                `}
              </div>
            `})}
      ...
      <div class="panel-climate">
        ...
        >
          ...
          <path
            ...
            stroke-dasharray="${M.toFixed(1)} ${(Hn+20).toFixed(1)}"
          ...
          <path
            ...
            stroke-width="14"
            stroke-linecap="round"
            stroke-dasharray="${T.toFixed(1)} ${(Yn+20).toFixed(1)}"
    ...
    `}_renderEmptyCells(t){const e=ha(t,this._gridCols);let i=0;for(const e of Object.values(t))i=Math.max(i,e.row+e.h);const s=Math.max(i,this._gridRows||4),r=[];for(let t=0;t<s;t++)for(let i=0;i<this._gridCols;i++)e[t]?.[i]||r.push(j`
    ...
    `}render(){if(!this.hass)return j``;const t=this._resolveSlots(),e=this._entities();if(!this._selectedId){const t=Object.values(this.hass.devices??{}).filter(t=>t.identifiers?.some(([t])=>"smartvanio"===t));t.length&&(this._selectedId=t[0].identifiers.find(([t])=>"smartvanio"===t)[1])}if(!e&&!this._allSmartvanioDeviceIds().size)return j`<div class="picker"><div class="picker-title">SmartVan.io</div><div class="picker-empty">No devices found. Add a device via Settings → Devices & Services.</div></div>`;const i=e??{lights:[],switches:[],sensors:[],binary_sensors:[],numbers:[],selects:[]},s=this._levelEntities(t),r=(t,e)=>{const i=(t??[]).map(({entity:t,name:e})=>({eid:t,state:this.hass.states[t],_slotName:e})).filter(t=>t.eid&&this.hass.states[t.eid]),s=new Set(i.map(t=>t.eid));return[...i,...e.filter(t=>!s.has(t.eid))]},a=r(t?.lights,i.lights);r(t?.switches,this._powerSwitches(i.switches));const n=(new Date).getHours(),o=n<12?"Good Morning":n<18?"Good Afternoon":"Good Evening",l=t?.topbarStats??[],d=this._getTankData(i,t);let c=null;if(!l.length){const e=t?.temperature??i.sensors.find(({eid:t})=>/temperature/.test(t)&&!/heater/.test(t))?.eid,s=e&&parseFloat(this.hass.states[e]?.state)||null,r=i.sensors.find(({eid:t})=>/battery/.test(t))?.eid,a=r?parseFloat(this.hass.states[r]?.state):null,n=null!==a?Math.max(0,Math.min(100,(a-11.5)/1.7*100)):null,o=d.find(t=>/water/i.test(t.label)),l=d.find(t=>/waste|grey/i.test(t.label));c={cabinTemp:s,battV:a,battPct:n,waterTank:o,wasteTank:l}}return j`
      <div class="hmi">
        <!-- Top bar -->
        <div class="top-bar">
          <span class="tb-greeting">${o} <span style="font-size:10px;opacity:0.4;font-weight:400">v124</span></span>
          <div class="tb-stats">
          ...
          <div class="tb-right">
            ...
            `:j`
              <span class="tb-cfg" @click=${()=>this._toggleTheme()} title="Toggle theme">
                <ha-icon icon="${"dark"===this._theme?"mdi:weather-sunny":"mdi:weather-night"}" style="--mdc-icon-size:16px"></ha-icon>
              </span>
              <span class="tb-cfg ${"devices"===this._page?"active":""}" @click=${()=>{this._page="devices"===this._page?"dashboard":"devices"}} title="Devices">
